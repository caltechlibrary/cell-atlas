...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/3_1_Snegevensis.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/3_2_Cnecator.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/3_2a_Babortus.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/3_2b_Mformicica.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/3_3_Hgracilis.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/3_4_Ccrescentus.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/3_5_Cjejuni.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/3_5a_Bburgdorferi.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/3_6_Vspinosum.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/3_6a_Pvanneervenii.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/3_7_Hwalsbyi.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/3_7a_Hsalinarum.mp4')
} else {
library(doivideo)
