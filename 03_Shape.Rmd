...
```{R 3-1, echo=FALSE, screenshot.alt='movie_stills/3_1.png' , fig.cap= 'Simkania negevensis Collected by: [Martin Pilhofer](#martin_pilhofer) Movie DOI: [10.22002/D1.1477](https://doi.org/10.22002/D1.1477)'}
library(doivideo)
...
```{R 3-2, echo=FALSE, screenshot.alt='movie_stills/3_2.png' , fig.cap= 'Cupriavidus necator Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1478](https://doi.org/10.22002/D1.1478)'}
library(doivideo)
...
```{R 3-2a, echo=FALSE, screenshot.alt='movie_stills/3_2a.png' , fig.cap= 'Brucella abortus Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1484](https://doi.org/10.22002/D1.1484)'}
library(doivideo)
...
```{R 3-2b, echo=FALSE, screenshot.alt='movie_stills/3_2b.png' , fig.cap= 'Methanoregula formicica Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1485](https://doi.org/10.22002/D1.1485)'}
library(doivideo)
...
```{R 3-3, echo=FALSE, screenshot.alt='movie_stills/3_3.png' , fig.cap= 'Hylemonella gracilis Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1479](https://doi.org/10.22002/D1.1479)'}
library(doivideo)
...
```{R 3-4, echo=FALSE, screenshot.alt='movie_stills/3_4.png' , fig.cap= 'Caulobacter crescentus Collected by: [Prabha Dias](#prabha_dias) Movie DOI: [10.22002/D1.1480](https://doi.org/10.22002/D1.1480)'}
library(doivideo)
...
```{R 3-5, echo=FALSE, screenshot.alt='movie_stills/3_5.png' , fig.cap= 'Campylobacter jejuni Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1481](https://doi.org/10.22002/D1.1481)'}
library(doivideo)
...
```{R 3-5a, echo=FALSE, screenshot.alt='movie_stills/3_5a.png' , fig.cap= 'Borrelia burgdorferi Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1486](https://doi.org/10.22002/D1.1486)'}
library(doivideo)
...
```{R 3-6, echo=FALSE, screenshot.alt='movie_stills/3_6.png' , fig.cap= 'Verrucomicrobium spinosum Collected by: [Martin Pilhofer](#martin_pilhofer) Movie DOI: [10.22002/D1.1482](https://doi.org/10.22002/D1.1482)'}
library(doivideo)
...
```{R 3-6a, echo=FALSE, screenshot.alt='movie_stills/3_6a.png' , fig.cap= 'Prosthecobacter vanneervenii Collected by: [Martin Pilhofer](#martin_pilhofer) Movie DOI: [10.22002/D1.1487](https://doi.org/10.22002/D1.1487)'}
library(doivideo)
...
```{R 3-7, echo=FALSE, screenshot.alt='movie_stills/3_7.png' , fig.cap= 'Haloquadratum walsbyi Collected by: [Zhuo Li](#zhuo_li) Movie DOI: [10.22002/D1.1483](https://doi.org/10.22002/D1.1483)'}
library(doivideo)
...
```{R 3-7a, echo=FALSE, screenshot.alt='movie_stills/3_7a.png' , fig.cap= 'Halobacterium salinarum Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1488](https://doi.org/10.22002/D1.1488)'}
library(doivideo)
