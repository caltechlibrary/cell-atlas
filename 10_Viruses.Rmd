...
```{R 10-1, echo=FALSE, screenshot.alt='movie_stills/10_1.png' , fig.cap= 'Shewanella oneidensis Collected by: Poorna Subramanian [10.22002/D1.1586](https://doi.org/10.22002/D1.1586)'}
library(doivideo)
...
```{R 10-2, echo=FALSE, screenshot.alt='movie_stills/10_2.png' , fig.cap= 'Bacteroidetes JT5 Collected by: Elitza Tocheva [10.22002/D1.1587](https://doi.org/10.22002/D1.1587)'}
library(doivideo)
...
```{R 10-3, echo=FALSE, screenshot.alt='movie_stills/10_3.png' , fig.cap= 'Shewanella oneidensis Collected by: Poorna Subramanian [10.22002/D1.1588](https://doi.org/10.22002/D1.1588)'}
library(doivideo)
...
```{R 10-4, echo=FALSE, screenshot.alt='movie_stills/10_4.png' , fig.cap= 'Vibrio cholerae Collected by: Yi-Wei Chang [10.22002/D1.1589](https://doi.org/10.22002/D1.1589)'}
library(doivideo)
...
```{R 10-5, echo=FALSE, screenshot.alt='movie_stills/10_5.png' , fig.cap= 'Escherichia coli Collected by: Yi-Wei Chang [10.22002/D1.1590](https://doi.org/10.22002/D1.1590)'}
library(doivideo)
...
```{R 10-6, echo=FALSE, screenshot.alt='movie_stills/10_6.png' , fig.cap= 'Caulobacter crescentus Collected by: Elizabeth Wright [10.22002/D1.1591](https://doi.org/10.22002/D1.1591)'}
library(doivideo)
...
```{R 10-6a, echo=FALSE, screenshot.alt='movie_stills/10_6a.png' , fig.cap= 'Caulobacter crescentus Collected by: Elizabeth Wright [10.22002/D1.1596](https://doi.org/10.22002/D1.1596)'}
library(doivideo)
...
```{R 10-7, echo=FALSE, screenshot.alt='movie_stills/10_7.png' , fig.cap= 'Vibrio cholerae Collected by: Poorna Subramanian [10.22002/D1.1592](https://doi.org/10.22002/D1.1592)'}
library(doivideo)
...
```{R 10-8, echo=FALSE, screenshot.alt='movie_stills/10_8.png' , fig.cap= 'Sulfolobus solfataricus Collected by: Lu Gan [10.22002/D1.1593](https://doi.org/10.22002/D1.1593)'}
library(doivideo)
...
```{R 10-9, echo=FALSE, screenshot.alt='movie_stills/10_9.png' , fig.cap= 'Sulfolobus solfataricus Collected by: Lu Gan [10.22002/D1.1594](https://doi.org/10.22002/D1.1594)'}
library(doivideo)
...
```{R 10-10, echo=FALSE, screenshot.alt='movie_stills/10_10.png' , fig.cap= 'Shewanella oneidensis Collected by: Lauren Ann Metskas [10.22002/D1.1595](https://doi.org/10.22002/D1.1595)'}
library(doivideo)
