...
(ref:10-1) [Shewanella oneidensis](#tree) Collected by: [Poorna Subramanian](#poorna_subramanian) Movie DOI: [10.22002/D1.1586](https://doi.org/10.22002/D1.1586)

```{R 10-1, echo=FALSE, screenshot.alt='movie_stills/10_1.png' , fig.cap= '(ref:10-1)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/10_1_Soneidensis_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1586',0,'movie_stills/10_1.png')}
```
...
(ref:10-2) [Bacteroidetes JT5](#tree) Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1587](https://doi.org/10.22002/D1.1587)

```{R 10-2, echo=FALSE, screenshot.alt='movie_stills/10_2.png' , fig.cap= '(ref:10-2)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/10_2_Bacteroidetes_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1587',0,'movie_stills/10_2.png')}
```
...
(ref:10-3) [Shewanella oneidensis](#tree) Collected by: [Poorna Subramanian](#poorna_subramanian) Movie DOI: [10.22002/D1.1588](https://doi.org/10.22002/D1.1588)

```{R 10-3, echo=FALSE, screenshot.alt='movie_stills/10_3.png' , fig.cap= '(ref:10-3)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/10_3_Soneidensis_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1588',0,'movie_stills/10_3.png')}
```
...
(ref:10-4) [Vibrio cholerae](#tree) Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1589](https://doi.org/10.22002/D1.1589)

```{R 10-4, echo=FALSE, screenshot.alt='movie_stills/10_4.png' , fig.cap= '(ref:10-4)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/10_4_Vcholerae_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1589',0,'movie_stills/10_4.png')}
```
...
(ref:10-5) [Escherichia coli](#tree) Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1590](https://doi.org/10.22002/D1.1590)

```{R 10-5, echo=FALSE, screenshot.alt='movie_stills/10_5.png' , fig.cap= '(ref:10-5)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/10_5_Ecoli_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1590',0,'movie_stills/10_5.png')}
```

## Head Fibers
Other phage use bacterial appendages in an even cleverer way. These φCb13 siphophage take advantage of the cell’s motility to hitch a ride to the cell. They have a filament on their head that wraps into the helical groove of the *Caulobacter crescentus* flagellum. Remember that flagella can spin either clockwise or counter-clockwise. If this single polar flagellum spins clockwise, pushing the cell body, the attached phage would unscrew like a nut off the end of the flagellum. But if the flagellum spins counter-clockwise, the nut will instead spin down to the cell body, where its tail fibers will find their receptors and its tail will inject the genome [More: φCb13 infection](#φCb13_infection).

(ref:10-6) [Caulobacter crescentus](#tree) Collected by: [Elizabeth Wright](#elizabeth_wright) Movie DOI: [10.22002/D1.1591](https://doi.org/10.22002/D1.1591)

```{R 10-6, echo=FALSE, screenshot.alt='movie_stills/10_6.png' , fig.cap= '(ref:10-6)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/10_6_Ccrescentus_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1591',0,'movie_stills/10_6.png')}
```

### More: φCb13 infection{-#φCb13_infection}
...
(ref:10-6a) [Caulobacter crescentus](#tree) Collected by: [Elizabeth Wright](#elizabeth_wright) Movie DOI: [10.22002/D1.1596](https://doi.org/10.22002/D1.1596)

```{R 10-6a, echo=FALSE, screenshot.alt='movie_stills/10_6a.png' , fig.cap= '(ref:10-6a)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/10_6a_Ccrescentus_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1596',0,'movie_stills/10_6a.png')}
```
...
(ref:10-7) [Vibrio cholerae](#tree) Collected by: [Poorna Subramanian](#poorna_subramanian) Movie DOI: [10.22002/D1.1592](https://doi.org/10.22002/D1.1592)

```{R 10-7, echo=FALSE, screenshot.alt='movie_stills/10_7.png' , fig.cap= '(ref:10-7)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/10_7_Vcholerae_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1592',0,'movie_stills/10_7.png')}
```

## Virus-Associated Pyramids
Some archaeal phage make an even more dramatic exit, through <u>v</u>irus-<u>a</u>ssociated <u>p</u>yramids, or **VAPs**. You can see these escape hatches in this *Sulfolobus solfataricus* cell infected with *<u>S</u>ulfolobus* <u>T</u>urreted <u>I</u>cosahedral <u>V</u>irus (STIV) [Schematic: STIV structure](#STIV_structure). The VAPs are made from a single phage-encoded protein that self-assembles into a seven-sided pyramid in the membrane. Note how the VAPs poke through and disrupt the cell’s surface layer. Note also the many, many copies the phage has made. We sometimes see storage granules inside VAPs, likely simply pushed there by excluding forces from the densely-packed nucleoid and assembling viral capsids in the center of the cell.

(ref:10-8) [Sulfolobus solfataricus](#tree) Collected by: [Lu Gan](#lu_gan) Movie DOI: [10.22002/D1.1593](https://doi.org/10.22002/D1.1593)

```{R 10-8, echo=FALSE, screenshot.alt='movie_stills/10_8.png' , fig.cap= '(ref:10-8)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/10_8_Ssolfataricus_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1593',0,'movie_stills/10_8.png')}
```

### Schematic: STIV structure {-#STIV_structure}
```{R}
...
(ref:10-9) [Sulfolobus solfataricus](#tree) Collected by: [Lu Gan](#lu_gan) Movie DOI: [10.22002/D1.1594](https://doi.org/10.22002/D1.1594)

```{R 10-9, echo=FALSE, screenshot.alt='movie_stills/10_9.png' , fig.cap= '(ref:10-9)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/10_9_Ssolfataricus_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1594',0,'movie_stills/10_9.png')}
```
...
(ref:10-10) [Shewanella oneidensis](#tree) Collected by: [Lauren Ann Metskas](#lauren_ann_metskas) Movie DOI: [10.22002/D1.1595](https://doi.org/10.22002/D1.1595)

```{R 10-10, echo=FALSE, screenshot.alt='movie_stills/10_10.png' , fig.cap= '(ref:10-10)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/10_10_Soneidensis_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1595',0,'movie_stills/10_10.png')}
```

## Summary {#summary10}

```{R}
knitr::include_graphics('img/summaries/10_Viruses.gif')
```
