...
```{R echo=FALSE, screenshot.alt='movie_stills/0_1.png' , fig.cap= 'Campylobacter jejuni Collected by: Morgan Beeby [10.22002/D1.1462](https://doi.org/10.22002/D1.1462)'}
library(doivideo)
doivideo('10.22002/D1.1462',0)
```
...
```{R echo=FALSE, screenshot.alt='movie_stills/1_1.png' , fig.cap= 'Staphylococcus aureus Collected by: David Rogers [10.22002/D1.1463](https://doi.org/10.22002/D1.1463)'}
library(doivideo)
doivideo('10.22002/D1.1463',0)
```

### Structural biology toolkit {#Structural_biology_toolkit}
```{R}
...
```{R echo=FALSE, screenshot.alt='movie_stills/1_2.png' , fig.cap= 'Escherichia coli Collected by: Howard Berg [10.22002/D1.1464](https://doi.org/10.22002/D1.1464)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/1_3.png' , fig.cap= 'Shewanella oneidensis Collected by: Sahand Pirbadian [10.22002/D1.1465](https://doi.org/10.22002/D1.1465)'}
library(doivideo)
doivideo('10.22002/D1.1465',0)
```

### Electron microscopy modes {#Electron_microscopy_modes}
```{R}
...
```{R echo=FALSE, screenshot.alt='movie_stills/1_4.png' , fig.cap= 'Shewanella oneidensis Collected by: Mohammed Kaplan [10.22002/D1.1466](https://doi.org/10.22002/D1.1466)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/1_5.png' , fig.cap= 'Caulobacter crescentus Collected by: Steven Wang [10.22002/D1.1467](https://doi.org/10.22002/D1.1467)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/1_6.png' , fig.cap= 'Caulobacter crescentus Collected by: Steven Wang [10.22002/D1.1468](https://doi.org/10.22002/D1.1468)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/1_7.png' , fig.cap= 'Campylobacter jejuni Collected by: Morgan Beeby [10.22002/D1.1469](https://doi.org/10.22002/D1.1469)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/1_8.png' , fig.cap= 'Campylobacter jejuni Collected by: Matthias WolfFadel Samatey [10.22002/D1.1470](https://doi.org/10.22002/D1.1470)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/1_9.png' , fig.cap= 'Campylobacter jejuni Collected by: Fadel Samatey [10.22002/D1.1471](https://doi.org/10.22002/D1.1471)'}
library(doivideo)
doivideo('10.22002/D1.1471',0)
```

### Structural biology timeline {#Structural_biology_timeline}
```{R}
...
```{R echo=FALSE, screenshot.alt='movie_stills/1_10.png' , fig.cap= 'Bdellovibrio bacteriovorus Collected by: Yi-Wei Chang [10.22002/D1.1472](https://doi.org/10.22002/D1.1472)'}
library(doivideo)
doivideo('10.22002/D1.1472',0)
```

## More–Difference mapping
...
```{R echo=FALSE, screenshot.alt='movie_stills/1_10a.png' , fig.cap= 'Campylobacter jejuni Collected by: Morgan Beeby [10.22002/D1.1473](https://doi.org/10.22002/D1.1473)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_1.png' , fig.cap= 'Mycoplasma genitalium Collected by: Gregory Henderson [10.22002/D1.1350](https://doi.org/10.22002/D1.1350)'}
library(doivideo)
...
### PDB: 5T4O ATP synthase and energy production {#PDB:_5T4O_ATP_synthase_and_energy_production}
```{R}
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_2.png' , fig.cap= 'Listeria monocytogenes Collected by: Ariane Briegel [10.22002/D1.1351](https://doi.org/10.22002/D1.1351)'}
library(doivideo)
doivideo('10.22002/D1.1351',0)
```

## More–Peptidoglycan architecture
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_2a.png' , fig.cap= 'Bacillus subtilis Collected by: Morgan Beeby [10.22002/D1.1360](https://doi.org/10.22002/D1.1360)'}
library(doivideo)
doivideo('10.22002/D1.1360',0)
```

## More–Methanobacterium formicicum
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_2b.png' , fig.cap= 'Methanobacterium formicicum Collected by: Elitza Tocheva [10.22002/D1.1361](https://doi.org/10.22002/D1.1361)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_3.png' , fig.cap= 'Hydrogenovibrio crunogenus Collected by: Cristina Iancu [10.22002/D1.1352](https://doi.org/10.22002/D1.1352)'}
library(doivideo)
doivideo('10.22002/D1.1352',0)
```

### PDB: 1EQ7 –Braun's lipoprotein {#PDB:_1EQ7_–Brauns_lipoprotein}
```{R}
...
## More–Diderm sacculus architecture
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_3a.png' , fig.cap= 'Escherichia coli Collected by: Lu Gan [10.22002/D1.1362](https://doi.org/10.22002/D1.1362)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_4.png' , fig.cap= 'Myxococcus xanthus Collected by: Yi-Wei Chang [10.22002/D1.1474](https://doi.org/10.22002/D1.1474)'}
library(doivideo)
doivideo('10.22002/D1.1474',0)
```

## More–Pearled vesicles
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_4a.png' , fig.cap= 'Borrelia burgdorferi 2 Collected by: Ariane Briegel [10.22002/D1.1363](https://doi.org/10.22002/D1.1363)'}
library(doivideo)
doivideo('10.22002/D1.1363',0)
```

## More–Tubular vesicles
Here, again from a *Borrelia burgdorferi* cell, you can see extended, tubular outer membrane vesicles.

```{R echo=FALSE, screenshot.alt='movie_stills/2_4b.png' , fig.cap= 'Borrelia burgdorferi Collected by: Ariane Briegel [10.22002/D1.1353](https://doi.org/10.22002/D1.1353)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_4c.png' , fig.cap= 'Myxococcus xanthus Collected by: Matthew Swulius [10.22002/D1.1364](https://doi.org/10.22002/D1.1364)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_4d.png' , fig.cap= 'Prosthecobacter debontii Collected by: Martin Pilhofer [10.22002/D1.1365](https://doi.org/10.22002/D1.1365)'}
library(doivideo)
doivideo('10.22002/D1.1365',0)
```

## More–Archaeal vesicles
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_4e.png' , fig.cap= 'Halomicrobium mukohataei Collected by: Ariane Briegel [10.22002/D1.1475](https://doi.org/10.22002/D1.1475)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_5.png' , fig.cap= 'Mycobacterium marinum Collected by: Elitza Tocheva [10.22002/D1.1354](https://doi.org/10.22002/D1.1354)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_6.png' , fig.cap= 'Caulobacter crescentus Collected by: Ariane Briegel [10.22002/D1.1355](https://doi.org/10.22002/D1.1355)'}
library(doivideo)
doivideo('10.22002/D1.1355',0)
```

### PDB: 5N97 Surface layer architecture {#PDB:_5N97_Surface_layer_architecture}
```{R}
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_6a.png' , fig.cap= 'Delftia acidovorans Collected by: Elitza Tocheva [10.22002/D1.1366](https://doi.org/10.22002/D1.1366)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_7.png' , fig.cap= 'Sulfolobus solfataricus Collected by: Lu Gan [10.22002/D1.1356](https://doi.org/10.22002/D1.1356)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_7a.png' , fig.cap= 'Methylomicrobium alcaliphilum Collected by: Songye Chen [10.22002/D1.1367](https://doi.org/10.22002/D1.1367)'}
library(doivideo)
doivideo('10.22002/D1.1367',0)
```

## More–Clostridium thermocellum
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_7b.png' , fig.cap= 'Clostridium thermocellum Collected by: William Nicolas [10.22002/D1.1476](https://doi.org/10.22002/D1.1476)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_7c.png' , fig.cap= 'Nitrosopumilis maritimus Collected by: Rasika Ramdasi [10.22002/D1.1368](https://doi.org/10.22002/D1.1368)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_7d.png' , fig.cap= 'Methanoregula formicica Collected by: Ariane Briegel [10.22002/D1.1369](https://doi.org/10.22002/D1.1369)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_8.png' , fig.cap= 'Methanospirillum hungatei Collected by: Ariane Briegel [10.22002/D1.1357](https://doi.org/10.22002/D1.1357)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_9.png' , fig.cap= 'Haloarcula argentinensis Collected by: Ariane Briegel [10.22002/D1.1358](https://doi.org/10.22002/D1.1358)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/2_10.png' , fig.cap= 'Bdellovibrio bacteriovorus Collected by: Yi-Wei Chang [10.22002/D1.1359](https://doi.org/10.22002/D1.1359)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/3_1.png' , fig.cap= 'Simkania negevensis Collected by: Martin Pilhofer [10.22002/D1.1477](https://doi.org/10.22002/D1.1477)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/3_2.png' , fig.cap= 'Cupriavidus necator Collected by: Morgan Beeby [10.22002/D1.1478](https://doi.org/10.22002/D1.1478)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/3_2a.png' , fig.cap= 'Brucella abortus Collected by: Ariane Briegel [10.22002/D1.1484](https://doi.org/10.22002/D1.1484)'}
library(doivideo)
doivideo('10.22002/D1.1484',0)
```

## More–Archaeal rods
Some archaeal species, like this *Methanoregula formicica*, are rod-shaped. The rigid surface layer seems to help define the shape, but the details are still unknown.

```{R echo=FALSE, screenshot.alt='movie_stills/3_2b.png' , fig.cap= 'Methanoregula formicica Collected by: Ariane Briegel [10.22002/D1.1485](https://doi.org/10.22002/D1.1485)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/3_3.png' , fig.cap= 'Hylemonella gracilis Collected by: Yi-Wei Chang [10.22002/D1.1479](https://doi.org/10.22002/D1.1479)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/3_4.png' , fig.cap= 'Caulobacter crescentus Collected by: Prabha Dias [10.22002/D1.1480](https://doi.org/10.22002/D1.1480)'}
library(doivideo)
doivideo('10.22002/D1.1480',0)
```

### PDB: 5U3C CTP synthase {#PDB:_5U3C_CTP_synthase}
```{R}
knitr::include_graphics('img/schematics/3_4_1.gif')
```
...
```{R echo=FALSE, screenshot.alt='movie_stills/3_5.png' , fig.cap= 'Campylobacter jejuni Collected by: Morgan Beeby [10.22002/D1.1481](https://doi.org/10.22002/D1.1481)'}
library(doivideo)
doivideo('10.22002/D1.1481',0)
```

## More–Borrelia burgdorferi
...
```{R echo=FALSE, screenshot.alt='movie_stills/3_5a.png' , fig.cap= 'Borrelia burgdorferi Collected by: Ariane Briegel [10.22002/D1.1486](https://doi.org/10.22002/D1.1486)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/3_6.png' , fig.cap= 'Verrucomicrobium spinosum Collected by: Martin Pilhofer [10.22002/D1.1482](https://doi.org/10.22002/D1.1482)'}
library(doivideo)
doivideo('10.22002/D1.1482',0)
```

### PDB: 6RIB Bactofilin {#PDB:_6RIB_Bactofilin}
```{R}
knitr::include_graphics('img/schematics/3_6_1.gif')
```
...
```{R echo=FALSE, screenshot.alt='movie_stills/3_6a.png' , fig.cap= 'Prosthecobacter vanneervenii Collected by: Martin Pilhofer [10.22002/D1.1487](https://doi.org/10.22002/D1.1487)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/3_7.png' , fig.cap= 'Haloquadratum walsbyi Collected by: Zhuo Li [10.22002/D1.1483](https://doi.org/10.22002/D1.1483)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/3_7a.png' , fig.cap= 'Halobacterium salinarum Collected by: Ariane Briegel [10.22002/D1.1488](https://doi.org/10.22002/D1.1488)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_1.png' , fig.cap= 'Caulobacter crescentus Collected by: Zhuo Li [10.22002/D1.1489](https://doi.org/10.22002/D1.1489)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_2.png' , fig.cap= 'Shewanella oneidensis Collected by: Poorna Subramanian [10.22002/D1.1490](https://doi.org/10.22002/D1.1490)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_3.png' , fig.cap= 'Rhodopseudomonas palustris Collected by: Alasdair McDowall [10.22002/D1.1491](https://doi.org/10.22002/D1.1491)'}
library(doivideo)
doivideo('10.22002/D1.1491',0)
```

### PDB: 6KGX –Photocomplexes {#PDB:_6KGX_–Photocomplexes}
```{R}
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_3a.png' , fig.cap= 'Methyloprofundus sedimenti Collected by: Elitza Tocheva [10.22002/D1.1499](https://doi.org/10.22002/D1.1499)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_4.png' , fig.cap= 'Chloroflexi Collected by: Elitza Tocheva [10.22002/D1.1492](https://doi.org/10.22002/D1.1492)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_5.png' , fig.cap= 'Clostridium thermocellum Collected by: Elitza Tocheva [10.22002/D1.1493](https://doi.org/10.22002/D1.1493)'}
library(doivideo)
doivideo('10.22002/D1.1493',0)
```

### PDB: 6TQH–AdhE spirosome structure {#PDB:_6TQH–AdhE_spirosome_structure}
```{R}
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_6.png' , fig.cap= 'Acetonema longum Collected by: Elitza Tocheva [10.22002/D1.1494](https://doi.org/10.22002/D1.1494)'}
library(doivideo)
doivideo('10.22002/D1.1494',0)
```

### PDB: 3DKT–Microcompartment shells {#PDB:_3DKT–Microcompartment_shells}
```{R}
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_7.png' , fig.cap= 'Thiomonas intermedia Collected by: Cristina Iancu [10.22002/D1.1495](https://doi.org/10.22002/D1.1495)'}
library(doivideo)
doivideo('10.22002/D1.1495',0)
```

## More–Carboxysome variety
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_7a.png' , fig.cap= 'Halothiobacillus neapolitanus Collected by: Cristina Iancu [10.22002/D1.1500](https://doi.org/10.22002/D1.1500)'}
library(doivideo)
doivideo('10.22002/D1.1500',0)
```

## More–Long carboxysomes
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_7b.png' , fig.cap= 'Hydrogenovibrio crunogenus Collected by: Cristina Iancu [10.22002/D1.1501](https://doi.org/10.22002/D1.1501)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_8.png' , fig.cap= 'Cupriavidus necator Collected by: Morgan Beeby [10.22002/D1.1496](https://doi.org/10.22002/D1.1496)'}
library(doivideo)
doivideo('10.22002/D1.1496',0)
```

## More–Storage granule growth
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_8a.png' , fig.cap= 'Lysobacter antibioticus Collected by: Morgan Beeby [10.22002/D1.1502](https://doi.org/10.22002/D1.1502)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_9.png' , fig.cap= 'Agrobacterium tumefaciens Collected by: Elitza Tocheva [10.22002/D1.1497](https://doi.org/10.22002/D1.1497)'}
library(doivideo)
doivideo('10.22002/D1.1497',0)
```

## More–Granule-containing carboxysomes
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_9a.png' , fig.cap= 'Hydrogenovibrio crunogenus Collected by: Cristina Iancu [10.22002/D1.1503](https://doi.org/10.22002/D1.1503)'}
library(doivideo)
doivideo('10.22002/D1.1503',0)
```

## More–Carboxysomes-granule connections
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_9b.png' , fig.cap= 'Halothiobacillus neapolitanus Collected by: Cristina Iancu [10.22002/D1.1504](https://doi.org/10.22002/D1.1504)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_10.png' , fig.cap= 'Halorubrum litoreum Collected by: Ariane Briegel [10.22002/D1.1498](https://doi.org/10.22002/D1.1498)'}
library(doivideo)
doivideo('10.22002/D1.1498',0)
```

## More–Haloferax gibbonsii granules
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_10a.png' , fig.cap= 'Haloferax gibbonsii Collected by: Ariane Briegel [10.22002/D1.1505](https://doi.org/10.22002/D1.1505)'}
library(doivideo)
doivideo('10.22002/D1.1505',0)
```

## More–Halohasta litchfieldiae granules
...
```{R echo=FALSE, screenshot.alt='movie_stills/4_10b.png' , fig.cap= 'Halohasta litchfieldiae Collected by: Zhuo Li [10.22002/D1.1506](https://doi.org/10.22002/D1.1506)'}
library(doivideo)
doivideo('10.22002/D1.1506',0)
```
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_1.png' , fig.cap= 'Thiomonas intermedia Collected by: Cristina Iancu [10.22002/D1.1507](https://doi.org/10.22002/D1.1507)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_2.png' , fig.cap= 'Caulobacter crescentus Collected by: Ariane Briegel [10.22002/D1.1508](https://doi.org/10.22002/D1.1508)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_3.png' , fig.cap= 'Hyphomonas neptunium Collected by: Jian Shi [10.22002/D1.1509](https://doi.org/10.22002/D1.1509)'}
library(doivideo)
doivideo('10.22002/D1.1509',0)
```

## More–Hyphomonas stalk
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_3a.png' , fig.cap= 'Hyphomonas neptunium Collected by: Jian Shi [10.22002/D1.1519](https://doi.org/10.22002/D1.1519)'}
library(doivideo)
doivideo('10.22002/D1.1519',0)
```

## More–Hyphomonas lifecycle
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_3b.png' , fig.cap= 'Hyphomonas neptunium Collected by: Jian Shi [10.22002/D1.1520](https://doi.org/10.22002/D1.1520)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_4.png' , fig.cap= 'Staphylococcus aureus Collected by: Georges Chreifi [10.22002/D1.1510](https://doi.org/10.22002/D1.1510)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_5.png' , fig.cap= 'Tetrasphaera remsis Collected by: Ariane Briegel [10.22002/D1.1511](https://doi.org/10.22002/D1.1511)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_6.png' , fig.cap= 'Idiomarina loihiensis Collected by: Morgan Beeby [10.22002/D1.1512](https://doi.org/10.22002/D1.1512)'}
library(doivideo)
doivideo('10.22002/D1.1512',0)
```

## More–Sphingopyxis alaskensis division
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_6a.png' , fig.cap= 'Sphingopyxis alaskensis Collected by: Morgan Beeby [10.22002/D1.1521](https://doi.org/10.22002/D1.1521)'}
library(doivideo)
doivideo('10.22002/D1.1521',0)
```

## More–Chloroflexi division
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_6b.png' , fig.cap= 'Chloroflexi Collected by: Elitza Tocheva [10.22002/D1.1522](https://doi.org/10.22002/D1.1522)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_7.png' , fig.cap= 'Caulobacter crescentus Collected by: Zhuo Li [10.22002/D1.1513](https://doi.org/10.22002/D1.1513)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_7a.png' , fig.cap= 'Caulobacter crescentus Collected by: Qing Yao [10.22002/D1.1523](https://doi.org/10.22002/D1.1523)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_8.png' , fig.cap= 'Agrobacterium tumefaciens Collected by: Elitza Tocheva [10.22002/D1.1514](https://doi.org/10.22002/D1.1514)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_9.png' , fig.cap= 'Cupriavidus necator Collected by: Morgan Beeby [10.22002/D1.1515](https://doi.org/10.22002/D1.1515)'}
library(doivideo)
doivideo('10.22002/D1.1515',0)
```

## More–Asymmetric constriction
This *C. necator* cell is at a late stage of cytokinesis. In most cells, constriction would be more or less uniform around the circumference by now, but in some cells, including this one, the asymmetry persists.

```{R echo=FALSE, screenshot.alt='movie_stills/5_9a.png' , fig.cap= 'Cupriavidus necator Collected by: Morgan Beeby [10.22002/D1.1524](https://doi.org/10.22002/D1.1524)'}
library(doivideo)
doivideo('10.22002/D1.1524',0)
```

### PDB: 5MN4 –FtsZ structure {#PDB:_5MN4_–FtsZ_structure}
```{R}
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_10.png' , fig.cap= 'Caulobacter crescentus Collected by: Qing Yao [10.22002/D1.1516](https://doi.org/10.22002/D1.1516)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_11.png' , fig.cap= 'Sulfolobus acidocaldarius Collected by: Shrawan Mageswaran [10.22002/D1.1517](https://doi.org/10.22002/D1.1517)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/5_12.png' , fig.cap= 'Sulfolobus acidocaldarius Collected by: Shrawan Mageswaran [10.22002/D1.1518](https://doi.org/10.22002/D1.1518)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_1.png' , fig.cap= 'Campylobacter jejuni Collected by: Morgan Beeby [10.22002/D1.1525](https://doi.org/10.22002/D1.1525)'}
library(doivideo)
doivideo('10.22002/D1.1525',0)
```

### PDB: 5WJT–Flagellum structure {#PDB:_5WJT–Flagellum_structure}
```{R}
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_2.png' , fig.cap= 'Bdellovibrio bacteriovorus Collected by: Yi-Wei Chang [10.22002/D1.1526](https://doi.org/10.22002/D1.1526)'}
library(doivideo)
doivideo('10.22002/D1.1526',0)
```

## More–Flagellar motor structure
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_2a.png' , fig.cap= 'Bdellovibrio bacteriovorus Collected by: Yi-Wei Chang [10.22002/D1.1537](https://doi.org/10.22002/D1.1537)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_3.png' , fig.cap= 'Hylemonella gracilis Collected by: Yi-Wei Chang [10.22002/D1.1527](https://doi.org/10.22002/D1.1527)'}
library(doivideo)
doivideo('10.22002/D1.1527',0)
```

## More–Flagellar motor disassembly
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_3a.png' , fig.cap= 'Pseudomonas aeruginosa Collected by: Ariane Briegel [10.22002/D1.1538](https://doi.org/10.22002/D1.1538)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_4.png' , fig.cap= 'Campylobacter jejuni Collected by: Morgan Beeby [10.22002/D1.1528](https://doi.org/10.22002/D1.1528)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_4a.png' , fig.cap= 'Helicobacter pylori Collected by: Yi-Wei Chang [10.22002/D1.1539](https://doi.org/10.22002/D1.1539)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_5.png' , fig.cap= 'Pseudomonas flexibilis Collected by: Morgan Beeby [10.22002/D1.1529](https://doi.org/10.22002/D1.1529)'}
library(doivideo)
doivideo('10.22002/D1.1529',0)
```

## More–Proteus mirabilis flagella
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_5a.png' , fig.cap= 'Proteus mirabilis Collected by: Qing Yao [10.22002/D1.1540](https://doi.org/10.22002/D1.1540)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_6.png' , fig.cap= 'Helicobacter hepaticus Collected by: Ariane Briegel [10.22002/D1.1530](https://doi.org/10.22002/D1.1530)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_7.png' , fig.cap= 'Borrelia burgdorferi Collected by: Ariane Briegel [10.22002/D1.1531](https://doi.org/10.22002/D1.1531)'}
library(doivideo)
doivideo('10.22002/D1.1531',0)
```

## More–Treponema primitia
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_8.png' , fig.cap= 'Methanoregula formicica Collected by: Ariane Briegel [10.22002/D1.1532](https://doi.org/10.22002/D1.1532)'}
library(doivideo)
doivideo('10.22002/D1.1532',0)
```

### PDB: 5TFY–Archaellum structure {#PDB:_5TFY–Archaellum_structure}
```{R}
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_9.png' , fig.cap= 'Thermococcus kodakaraensis Collected by: Ariane Briegel [10.22002/D1.1533](https://doi.org/10.22002/D1.1533)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_9a.png' , fig.cap= 'Thermococcus kodakaraensis Collected by: Ariane Briegel [10.22002/D1.1542](https://doi.org/10.22002/D1.1542)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_9b.png' , fig.cap= 'Thermococcus kodakaraensis Collected by: Ariane Briegel [10.22002/D1.1543](https://doi.org/10.22002/D1.1543)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_10.png' , fig.cap= 'Myxococcus xanthus Collected by: Yi-Wei Chang [10.22002/D1.1534](https://doi.org/10.22002/D1.1534)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_11.png' , fig.cap= 'Flavobacterium johnsoniae Collected by: Gregory Henderson [10.22002/D1.1535](https://doi.org/10.22002/D1.1535)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/6_12.png' , fig.cap= 'Mycoplasma pneumoniae Collected by: Gregory Henderson [10.22002/D1.1536](https://doi.org/10.22002/D1.1536)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/7_1.png' , fig.cap= 'Shewanella oneidensis Collected by: Mohammed Kaplan [10.22002/D1.1545](https://doi.org/10.22002/D1.1545)'}
library(doivideo)
doivideo('10.22002/D1.1545',0)
```

### PDB: 2CH7–Chemoreceptor structure {#PDB:_2CH7–Chemoreceptor_structure}
```{R}
...
```{R echo=FALSE, screenshot.alt='movie_stills/7_2.png' , fig.cap= 'Salmonella typhimurium Collected by: Morgan Beeby [10.22002/D1.1546](https://doi.org/10.22002/D1.1546)'}
library(doivideo)
doivideo('10.22002/D1.1546',0)
```

### PDB: 6S1K Chemosensory array architecture {#PDB:_6S1K_Chemosensory_array_architecture}
```{R}
...
```{R echo=FALSE, screenshot.alt='movie_stills/7_3.png' , fig.cap= 'Methanospirillum hungatei Collected by: Ariane Briegel [10.22002/D1.1547](https://doi.org/10.22002/D1.1547)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/7_4.png' , fig.cap= 'Vibrio cholerae Collected by: Ariane Briegel [10.22002/D1.1548](https://doi.org/10.22002/D1.1548)'}
library(doivideo)
doivideo('10.22002/D1.1548',0)
```

## More–Azospirillum brasilense aerotaxis
...
```{R echo=FALSE, screenshot.alt='movie_stills/7_4a.png' , fig.cap= 'Azospirillum brasilense Collected by: Ariane Briegel [10.22002/D1.1551](https://doi.org/10.22002/D1.1551)'}
library(doivideo)
doivideo('10.22002/D1.1551',0)
```
...
```{R echo=FALSE, screenshot.alt='movie_stills/7_5.png' , fig.cap= 'Methanoregula formicica Collected by: Ariane Briegel [10.22002/D1.1549](https://doi.org/10.22002/D1.1549)'}
library(doivideo)
doivideo('10.22002/D1.1549',0)
```

## More–Vibrio cholerae chemosensory arrays
...
```{R echo=FALSE, screenshot.alt='movie_stills/7_5a.png' , fig.cap= 'Vibrio cholerae Collected by: Ariane Briegel [10.22002/D1.1552](https://doi.org/10.22002/D1.1552)'}
library(doivideo)
doivideo('10.22002/D1.1552',0)
```
...
```{R echo=FALSE, screenshot.alt='movie_stills/7_6.png' , fig.cap= 'Magnetospirillum magneticum Collected by: Zhuo Li [10.22002/D1.1550](https://doi.org/10.22002/D1.1550)'}
library(doivideo)
doivideo('10.22002/D1.1550',0)
```

### PDB: 5JYG–MamK structure {#PDB:_5JYG–MamK_structure}
```{R}
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_1.png' , fig.cap= 'Caulobacter crescentus Collected by: Prabha Dias [10.22002/D1.1553](https://doi.org/10.22002/D1.1553)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_2.png' , fig.cap= 'Helicobacter pylori Collected by: Yi-Wei Chang [10.22002/D1.1554](https://doi.org/10.22002/D1.1554)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_3.png' , fig.cap= 'Thermococcus kodakaraensis Collected by: Debnath Ghosal [10.22002/D1.1555](https://doi.org/10.22002/D1.1555)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_4.png' , fig.cap= 'Caulobacter crescentus Collected by: Zhuo Li [10.22002/D1.1556](https://doi.org/10.22002/D1.1556)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_4a.png' , fig.cap= 'Prosthecobacter vanneervenii Collected by: Martin Pilhofer [10.22002/D1.1564](https://doi.org/10.22002/D1.1564)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_5.png' , fig.cap= 'Bacillus subtilis Collected by: Elitza Tocheva [10.22002/D1.1557](https://doi.org/10.22002/D1.1557)'}
library(doivideo)
doivideo('10.22002/D1.1557',0)
```

## More–Sporulation septum formation
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_5a.png' , fig.cap= 'Bacillus subtilis Collected by: Elitza Tocheva [10.22002/D1.1565](https://doi.org/10.22002/D1.1565)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_6.png' , fig.cap= 'Bacillus subtilis Collected by: Elitza Tocheva [10.22002/D1.1558](https://doi.org/10.22002/D1.1558)'}
library(doivideo)
doivideo('10.22002/D1.1558',0)
```

## More–Spore engulfment
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_6a.png' , fig.cap= 'Bacillus subtilis Collected by: Elitza Tocheva [10.22002/D1.1566](https://doi.org/10.22002/D1.1566)'}
library(doivideo)
doivideo('10.22002/D1.1566',0)
```

## More–Spore coating
In this later stage of sporulation, you can see that the *Bacillus subtilis* spore has now separated completely from the mother cell envelope. It has also moved away from the cell pole (this sometimes occurs even as the envelopes are still attached [More–Spore engulfment]). The layer flanking the spore on the right may be the assembling spore coat.

```{R echo=FALSE, screenshot.alt='movie_stills/8_6b.png' , fig.cap= 'Bacillus subtilis Collected by: Elitza Tocheva [10.22002/D1.1567](https://doi.org/10.22002/D1.1567)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_7.png' , fig.cap= 'Bacillus subtilis Collected by: Elitza Tocheva [10.22002/D1.1559](https://doi.org/10.22002/D1.1559)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_8.png' , fig.cap= 'Bacillus subtilis Collected by: Elitza Tocheva [10.22002/D1.1560](https://doi.org/10.22002/D1.1560)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_9.png' , fig.cap= 'Acetonema longum Collected by: Elitza Tocheva [10.22002/D1.1561](https://doi.org/10.22002/D1.1561)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_10.png' , fig.cap= 'Acetonema longum Collected by: Elitza Tocheva [10.22002/D1.1562](https://doi.org/10.22002/D1.1562)'}
library(doivideo)
doivideo('10.22002/D1.1562',0)
```

## More–Complete engulfment
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_10a.png' , fig.cap= 'Acetonema longum Collected by: Elitza Tocheva [10.22002/D1.1568](https://doi.org/10.22002/D1.1568)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_10b.png' , fig.cap= 'Acetonema longum Collected by: Elitza Tocheva [10.22002/D1.1569](https://doi.org/10.22002/D1.1569)'}
library(doivideo)
doivideo('10.22002/D1.1569',0)
```

## More–Sporomusa acidovorans sporulation
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_10c.png' , fig.cap= 'Sporomusa acidovorans Collected by: Elitza Tocheva [10.22002/D1.1570](https://doi.org/10.22002/D1.1570)'}
library(doivideo)
...
```{R echo=FALSE, screenshot.alt='movie_stills/8_11.png' , fig.cap= 'Acetonema longum Collected by: Elitza Tocheva [10.22002/D1.1563](https://doi.org/10.22002/D1.1563)'}
library(doivideo)
...
### EMD-20712 EMD-20713–Legionella T2SS structure {#EMD-20712_EMD-20713–Legionella_T2SS_structure}
```{R}
...
### EMD-0566 –Legionella T4SS structure {#EMD-0566_–Legionella_T4SS_structure}
```{R}
...
## More–Helicobacter pylori tubes
...
### EMD-20611 Injectisome structure {#EMD-20611_Injectisome_structure}
```{R}
...
### PDB: 5WQ8 Secretin structure {#PDB:_5WQ8_Secretin_structure}
```{R}
...
### PDB: 5URW–Primed T6SS structure {#PDB:_5URW–Primed_T6SS_structure}
```{R}
...
### PDB: 5URX–Fired T6SS structure {#PDB:_5URX–Fired_T6SS_structure}
```{R}
...
This digital segmentation of the MAC array you just saw [More–MACs] shows the overall order of the structure @shikuma2014. Outer sheaths are in blue, inner rods in green, tail fibers in orange, and networking fibers in white.
...
## More–Bdellovibrio bacteriovorus entry
...
10_6a_Caulobacter crescentus More–φCb13 infection
