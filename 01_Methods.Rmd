...
(ref:1-1) Staphylococcus aureus Collected by: [David Rogers](#david_rogers) Movie DOI: [10.22002/D1.1463](https://doi.org/10.22002/D1.1463)

```{R 1-1, echo=FALSE, screenshot.alt='movie_stills/1_1.jpg' , fig.cap= '(ref:1-1)'}
library(doivideo)
...
(ref:1-2) Escherichia coli Collected by: [Howard Berg](#howard_berg) Movie DOI: [10.22002/D1.1464](https://doi.org/10.22002/D1.1464)

```{R 1-2, echo=FALSE, screenshot.alt='movie_stills/1_2.jpg' , fig.cap= '(ref:1-2)'}
library(doivideo)
...
(ref:1-3) Shewanella oneidensis Collected by: [Sahand Pirbadian](#sahand_pirbadian) Movie DOI: [10.22002/D1.1465](https://doi.org/10.22002/D1.1465)

```{R 1-3, echo=FALSE, screenshot.alt='movie_stills/1_3.jpg' , fig.cap= '(ref:1-3)'}
library(doivideo)
...
(ref:1-4) Shewanella oneidensis Collected by: [Mohammed Kaplan](#mohammed_kaplan) Movie DOI: [10.22002/D1.1466](https://doi.org/10.22002/D1.1466)

```{R 1-4, echo=FALSE, screenshot.alt='movie_stills/1_4.jpg' , fig.cap= '(ref:1-4)'}
library(doivideo)
...
(ref:1-5) Caulobacter crescentus Collected by: [Steven Wang](#steven_wang) Movie DOI: [10.22002/D1.1467](https://doi.org/10.22002/D1.1467)

```{R 1-5, echo=FALSE, screenshot.alt='movie_stills/1_5.jpg' , fig.cap= '(ref:1-5)'}
library(doivideo)
...
(ref:1-6) Caulobacter crescentus Collected by: [Steven Wang](#steven_wang) Movie DOI: [10.22002/D1.1468](https://doi.org/10.22002/D1.1468)

```{R 1-6, echo=FALSE, screenshot.alt='movie_stills/1_6.jpg' , fig.cap= '(ref:1-6)'}
library(doivideo)
...
(ref:1-7) Campylobacter jejuni Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1469](https://doi.org/10.22002/D1.1469)

```{R 1-7, echo=FALSE, screenshot.alt='movie_stills/1_7.jpg' , fig.cap= '(ref:1-7)'}
library(doivideo)
...
(ref:1-8) Campylobacter jejuni Collected by: [Matthias WolfFadel Samatey](#matthias_wolffadel_samatey) Movie DOI: [10.22002/D1.1470](https://doi.org/10.22002/D1.1470)

```{R 1-8, echo=FALSE, screenshot.alt='movie_stills/1_8.jpg' , fig.cap= '(ref:1-8)'}
library(doivideo)
...
(ref:1-9) Campylobacter jejuni Collected by: [Fadel Samatey](#fadel_samatey) Movie DOI: [10.22002/D1.1471](https://doi.org/10.22002/D1.1471)

```{R 1-9, echo=FALSE, screenshot.alt='movie_stills/1_9.jpg' , fig.cap= '(ref:1-9)'}
library(doivideo)
...
(ref:1-10) Bdellovibrio bacteriovorus Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1472](https://doi.org/10.22002/D1.1472)

```{R 1-10, echo=FALSE, screenshot.alt='movie_stills/1_10.jpg' , fig.cap= '(ref:1-10)'}
library(doivideo)
...
(ref:1-10a) Campylobacter jejuni Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1473](https://doi.org/10.22002/D1.1473)

```{R 1-10a, echo=FALSE, screenshot.alt='movie_stills/1_10a.jpg' , fig.cap= '(ref:1-10a)'}
library(doivideo)
...
Chalfie et al. (1994). *Green fluorescent protein as a marker for gene expression*.[@chalfie1994]

Jensen. *Getting Started in Cryo-EM*.[@jensenInternet]
