...
There are two main types of electron microscopes [Schematic: Electron microscopy modes](#Electron_microscopy_modes). In a Scanning Electron Microscope (SEM), we detect electrons that are scattered backward from the sample, producing an image of the surface of the sample. The *Shewanella oneidensis* cells you see here were imaged by SEM. Note the magnified details of the cells’ shape and flagella compared to the light microscopy you just saw.
