...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/1_1_Saureus.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/1_2_Ecoli.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/1_3_Soneidensis.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/1_4_Soneidensis.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/1_5_Ccrescentus.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/1_6_Ccrescentus.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/1_7_Cjejuni.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/1_8_Cjejuni.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/1_9_Cjejuni.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/1_10_Bbacteriovorus.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/1_10a_Cjejuni.mp4')
} else {
library(doivideo)
