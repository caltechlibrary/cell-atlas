...
```{R 1-1, echo=FALSE, screenshot.alt='movie_stills/1_1.png' , fig.cap= 'Staphylococcus aureus Collected by: David Rogers [10.22002/D1.1463](https://doi.org/10.22002/D1.1463)'}
library(doivideo)
...
```{R 1-2, echo=FALSE, screenshot.alt='movie_stills/1_2.png' , fig.cap= 'Escherichia coli Collected by: Howard Berg [10.22002/D1.1464](https://doi.org/10.22002/D1.1464)'}
library(doivideo)
...
```{R 1-3, echo=FALSE, screenshot.alt='movie_stills/1_3.png' , fig.cap= 'Shewanella oneidensis Collected by: Sahand Pirbadian [10.22002/D1.1465](https://doi.org/10.22002/D1.1465)'}
library(doivideo)
...
```{R 1-4, echo=FALSE, screenshot.alt='movie_stills/1_4.png' , fig.cap= 'Shewanella oneidensis Collected by: Mohammed Kaplan [10.22002/D1.1466](https://doi.org/10.22002/D1.1466)'}
library(doivideo)
...
```{R 1-5, echo=FALSE, screenshot.alt='movie_stills/1_5.png' , fig.cap= 'Caulobacter crescentus Collected by: Steven Wang [10.22002/D1.1467](https://doi.org/10.22002/D1.1467)'}
library(doivideo)
...
```{R 1-6, echo=FALSE, screenshot.alt='movie_stills/1_6.png' , fig.cap= 'Caulobacter crescentus Collected by: Steven Wang [10.22002/D1.1468](https://doi.org/10.22002/D1.1468)'}
library(doivideo)
...
```{R 1-7, echo=FALSE, screenshot.alt='movie_stills/1_7.png' , fig.cap= 'Campylobacter jejuni Collected by: Morgan Beeby [10.22002/D1.1469](https://doi.org/10.22002/D1.1469)'}
library(doivideo)
...
```{R 1-8, echo=FALSE, screenshot.alt='movie_stills/1_8.png' , fig.cap= 'Campylobacter jejuni Collected by: Matthias WolfFadel Samatey [10.22002/D1.1470](https://doi.org/10.22002/D1.1470)'}
library(doivideo)
...
```{R 1-9, echo=FALSE, screenshot.alt='movie_stills/1_9.png' , fig.cap= 'Campylobacter jejuni Collected by: Fadel Samatey [10.22002/D1.1471](https://doi.org/10.22002/D1.1471)'}
library(doivideo)
...
```{R 1-10, echo=FALSE, screenshot.alt='movie_stills/1_10.png' , fig.cap= 'Bdellovibrio bacteriovorus Collected by: Yi-Wei Chang [10.22002/D1.1472](https://doi.org/10.22002/D1.1472)'}
library(doivideo)
...
```{R 1-10a, echo=FALSE, screenshot.alt='movie_stills/1_10a.png' , fig.cap= 'Campylobacter jejuni Collected by: Morgan Beeby [10.22002/D1.1473](https://doi.org/10.22002/D1.1473)'}
library(doivideo)
