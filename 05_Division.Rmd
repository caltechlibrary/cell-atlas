...
```{R 5-1, echo=FALSE, screenshot.alt='movie_stills/5_1.png' , fig.cap= 'Thiomonas intermedia Collected by: [Cristina Iancu](#cristina_iancu) Movie DOI: [10.22002/D1.1507](https://doi.org/10.22002/D1.1507)'}
library(doivideo)
...
```{R 5-2, echo=FALSE, screenshot.alt='movie_stills/5_2.png' , fig.cap= 'Caulobacter crescentus Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1508](https://doi.org/10.22002/D1.1508)'}
library(doivideo)
...
```{R 5-3, echo=FALSE, screenshot.alt='movie_stills/5_3.png' , fig.cap= 'Hyphomonas neptunium Collected by: [Jian Shi](#jian_shi) Movie DOI: [10.22002/D1.1509](https://doi.org/10.22002/D1.1509)'}
library(doivideo)
...
```{R 5-3a, echo=FALSE, screenshot.alt='movie_stills/5_3a.png' , fig.cap= 'Hyphomonas neptunium Collected by: [Jian Shi](#jian_shi) Movie DOI: [10.22002/D1.1519](https://doi.org/10.22002/D1.1519)'}
library(doivideo)
...
```{R 5-3b, echo=FALSE, screenshot.alt='movie_stills/5_3b.png' , fig.cap= 'Hyphomonas neptunium Collected by: [Jian Shi](#jian_shi) Movie DOI: [10.22002/D1.1520](https://doi.org/10.22002/D1.1520)'}
library(doivideo)
...
```{R 5-4, echo=FALSE, screenshot.alt='movie_stills/5_4.png' , fig.cap= 'Staphylococcus aureus Collected by: [Georges Chreifi](#georges_chreifi) Movie DOI: [10.22002/D1.1510](https://doi.org/10.22002/D1.1510)'}
library(doivideo)
...
```{R 5-5, echo=FALSE, screenshot.alt='movie_stills/5_5.png' , fig.cap= 'Tetrasphaera remsis Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1511](https://doi.org/10.22002/D1.1511)'}
library(doivideo)
...
```{R 5-6, echo=FALSE, screenshot.alt='movie_stills/5_6.png' , fig.cap= 'Idiomarina loihiensis Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1512](https://doi.org/10.22002/D1.1512)'}
library(doivideo)
...
```{R 5-6a, echo=FALSE, screenshot.alt='movie_stills/5_6a.png' , fig.cap= 'Sphingopyxis alaskensis Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1521](https://doi.org/10.22002/D1.1521)'}
library(doivideo)
...
```{R 5-6b, echo=FALSE, screenshot.alt='movie_stills/5_6b.png' , fig.cap= 'Chloroflexi Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1522](https://doi.org/10.22002/D1.1522)'}
library(doivideo)
...
```{R 5-7, echo=FALSE, screenshot.alt='movie_stills/5_7.png' , fig.cap= 'Caulobacter crescentus Collected by: [Zhuo Li](#zhuo_li) Movie DOI: [10.22002/D1.1513](https://doi.org/10.22002/D1.1513)'}
library(doivideo)
...
```{R 5-7a, echo=FALSE, screenshot.alt='movie_stills/5_7a.png' , fig.cap= 'Caulobacter crescentus Collected by: [Qing Yao](#qing_yao) Movie DOI: [10.22002/D1.1523](https://doi.org/10.22002/D1.1523)'}
library(doivideo)
...
```{R 5-8, echo=FALSE, screenshot.alt='movie_stills/5_8.png' , fig.cap= 'Agrobacterium tumefaciens Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1514](https://doi.org/10.22002/D1.1514)'}
library(doivideo)
...
```{R 5-9, echo=FALSE, screenshot.alt='movie_stills/5_9.png' , fig.cap= 'Cupriavidus necator Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1515](https://doi.org/10.22002/D1.1515)'}
library(doivideo)
...
```{R 5-9a, echo=FALSE, screenshot.alt='movie_stills/5_9a.png' , fig.cap= 'Cupriavidus necator Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1524](https://doi.org/10.22002/D1.1524)'}
library(doivideo)
...
```{R 5-10, echo=FALSE, screenshot.alt='movie_stills/5_10.png' , fig.cap= 'Caulobacter crescentus Collected by: [Qing Yao](#qing_yao) Movie DOI: [10.22002/D1.1516](https://doi.org/10.22002/D1.1516)'}
library(doivideo)
...
```{R 5-11, echo=FALSE, screenshot.alt='movie_stills/5_11.png' , fig.cap= 'Sulfolobus acidocaldarius Collected by: [Shrawan Mageswaran](#shrawan_mageswaran) Movie DOI: [10.22002/D1.1517](https://doi.org/10.22002/D1.1517)'}
library(doivideo)
...
```{R 5-12, echo=FALSE, screenshot.alt='movie_stills/5_12.png' , fig.cap= 'Sulfolobus acidocaldarius Collected by: [Shrawan Mageswaran](#shrawan_mageswaran) Movie DOI: [10.22002/D1.1518](https://doi.org/10.22002/D1.1518)'}
library(doivideo)
