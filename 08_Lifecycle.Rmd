...
(ref:8-1) Caulobacter crescentus Collected by: [Prabha Dias](#prabha_dias) Movie DOI: [10.22002/D1.1553](https://doi.org/10.22002/D1.1553)

```{R 8-1, echo=FALSE, screenshot.alt='movie_stills/8_1.jpg' , fig.cap= '(ref:8-1)'}
library(doivideo)
...
(ref:8-2) Helicobacter pylori Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1554](https://doi.org/10.22002/D1.1554)

```{R 8-2, echo=FALSE, screenshot.alt='movie_stills/8_2.jpg' , fig.cap= '(ref:8-2)'}
library(doivideo)
...
(ref:8-3) Thermococcus kodakaraensis Collected by: [Debnath Ghosal](#debnath_ghosal) Movie DOI: [10.22002/D1.1555](https://doi.org/10.22002/D1.1555)

```{R 8-3, echo=FALSE, screenshot.alt='movie_stills/8_3.jpg' , fig.cap= '(ref:8-3)'}
library(doivideo)
...
(ref:8-4) Caulobacter crescentus Collected by: [Zhuo Li](#zhuo_li) Movie DOI: [10.22002/D1.1556](https://doi.org/10.22002/D1.1556)

```{R 8-4, echo=FALSE, screenshot.alt='movie_stills/8_4.jpg' , fig.cap= '(ref:8-4)'}
library(doivideo)
...
(ref:8-4a) Prosthecobacter vanneervenii Collected by: [Martin Pilhofer](#martin_pilhofer) Movie DOI: [10.22002/D1.1564](https://doi.org/10.22002/D1.1564)

```{R 8-4a, echo=FALSE, screenshot.alt='movie_stills/8_4a.jpg' , fig.cap= '(ref:8-4a)'}
library(doivideo)
...
(ref:8-5) Bacillus subtilis Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1557](https://doi.org/10.22002/D1.1557)

```{R 8-5, echo=FALSE, screenshot.alt='movie_stills/8_5.jpg' , fig.cap= '(ref:8-5)'}
library(doivideo)
doivideo('10.22002/D1.1557',0)
```

### Sporulation septum formation{#Sporulation_septum_formation}
...
(ref:8-5a) Bacillus subtilis Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1565](https://doi.org/10.22002/D1.1565)

```{R 8-5a, echo=FALSE, screenshot.alt='movie_stills/8_5a.jpg' , fig.cap= '(ref:8-5a)'}
library(doivideo)
...
(ref:8-6) Bacillus subtilis Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1558](https://doi.org/10.22002/D1.1558)

```{R 8-6, echo=FALSE, screenshot.alt='movie_stills/8_6.jpg' , fig.cap= '(ref:8-6)'}
library(doivideo)
doivideo('10.22002/D1.1558',0)
```

### Spore engulfment{#Spore_engulfment}
...
(ref:8-6a) Bacillus subtilis Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1566](https://doi.org/10.22002/D1.1566)

```{R 8-6a, echo=FALSE, screenshot.alt='movie_stills/8_6a.jpg' , fig.cap= '(ref:8-6a)'}
library(doivideo)
doivideo('10.22002/D1.1566',0)
```

### Spore coating{#Spore_coating}
In this later stage of sporulation, you can see that the *Bacillus subtilis* spore has now separated completely from the mother cell envelope. It has also moved away from the cell pole (this sometimes occurs even as the envelopes are still attached [More: Spore engulfment](#Spore_engulfment)). The layer flanking the spore on the right may be the assembling spore coat.

(ref:8-6b) Bacillus subtilis Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1567](https://doi.org/10.22002/D1.1567)

```{R 8-6b, echo=FALSE, screenshot.alt='movie_stills/8_6b.jpg' , fig.cap= '(ref:8-6b)'}
library(doivideo)
...
(ref:8-7) Bacillus subtilis Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1559](https://doi.org/10.22002/D1.1559)

```{R 8-7, echo=FALSE, screenshot.alt='movie_stills/8_7.jpg' , fig.cap= '(ref:8-7)'}
library(doivideo)
...
(ref:8-8) Bacillus subtilis Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1560](https://doi.org/10.22002/D1.1560)

```{R 8-8, echo=FALSE, screenshot.alt='movie_stills/8_8.jpg' , fig.cap= '(ref:8-8)'}
library(doivideo)
...
(ref:8-9) Acetonema longum Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1561](https://doi.org/10.22002/D1.1561)

```{R 8-9, echo=FALSE, screenshot.alt='movie_stills/8_9.jpg' , fig.cap= '(ref:8-9)'}
library(doivideo)
...
(ref:8-10) Acetonema longum Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1562](https://doi.org/10.22002/D1.1562)

```{R 8-10, echo=FALSE, screenshot.alt='movie_stills/8_10.jpg' , fig.cap= '(ref:8-10)'}
library(doivideo)
doivideo('10.22002/D1.1562',0)
```

### Complete engulfment{#Complete_engulfment}
...
(ref:8-10a) Acetonema longum Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1568](https://doi.org/10.22002/D1.1568)

```{R 8-10a, echo=FALSE, screenshot.alt='movie_stills/8_10a.jpg' , fig.cap= '(ref:8-10a)'}
library(doivideo)
doivideo('10.22002/D1.1568',0)
```

### Mature spore{#Mature_spore}
...
(ref:8-10b) Acetonema longum Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1569](https://doi.org/10.22002/D1.1569)

```{R 8-10b, echo=FALSE, screenshot.alt='movie_stills/8_10b.jpg' , fig.cap= '(ref:8-10b)'}
library(doivideo)
doivideo('10.22002/D1.1569',0)
```

### Sporomusa acidovorans sporulation{#Sporomusa_acidovorans_sporulation}
...
(ref:8-10c) Sporomusa acidovorans Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1570](https://doi.org/10.22002/D1.1570)

```{R 8-10c, echo=FALSE, screenshot.alt='movie_stills/8_10c.jpg' , fig.cap= '(ref:8-10c)'}
library(doivideo)
...
(ref:8-11) Acetonema longum Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1563](https://doi.org/10.22002/D1.1563)

```{R 8-11, echo=FALSE, screenshot.alt='movie_stills/8_11.jpg' , fig.cap= '(ref:8-11)'}
library(doivideo)
