...
```{R 8-1, echo=FALSE, screenshot.alt='movie_stills/8_1.png' , fig.cap= 'Caulobacter crescentus Collected by: Prabha Dias [10.22002/D1.1553](https://doi.org/10.22002/D1.1553)'}
library(doivideo)
...
```{R 8-2, echo=FALSE, screenshot.alt='movie_stills/8_2.png' , fig.cap= 'Helicobacter pylori Collected by: Yi-Wei Chang [10.22002/D1.1554](https://doi.org/10.22002/D1.1554)'}
library(doivideo)
...
```{R 8-3, echo=FALSE, screenshot.alt='movie_stills/8_3.png' , fig.cap= 'Thermococcus kodakaraensis Collected by: Debnath Ghosal [10.22002/D1.1555](https://doi.org/10.22002/D1.1555)'}
library(doivideo)
...
```{R 8-4, echo=FALSE, screenshot.alt='movie_stills/8_4.png' , fig.cap= 'Caulobacter crescentus Collected by: Zhuo Li [10.22002/D1.1556](https://doi.org/10.22002/D1.1556)'}
library(doivideo)
...
```{R 8-4a, echo=FALSE, screenshot.alt='movie_stills/8_4a.png' , fig.cap= 'Prosthecobacter vanneervenii Collected by: Martin Pilhofer [10.22002/D1.1564](https://doi.org/10.22002/D1.1564)'}
library(doivideo)
...
```{R 8-5, echo=FALSE, screenshot.alt='movie_stills/8_5.png' , fig.cap= 'Bacillus subtilis Collected by: Elitza Tocheva [10.22002/D1.1557](https://doi.org/10.22002/D1.1557)'}
library(doivideo)
...
```{R 8-5a, echo=FALSE, screenshot.alt='movie_stills/8_5a.png' , fig.cap= 'Bacillus subtilis Collected by: Elitza Tocheva [10.22002/D1.1565](https://doi.org/10.22002/D1.1565)'}
library(doivideo)
...
```{R 8-6, echo=FALSE, screenshot.alt='movie_stills/8_6.png' , fig.cap= 'Bacillus subtilis Collected by: Elitza Tocheva [10.22002/D1.1558](https://doi.org/10.22002/D1.1558)'}
library(doivideo)
...
```{R 8-6a, echo=FALSE, screenshot.alt='movie_stills/8_6a.png' , fig.cap= 'Bacillus subtilis Collected by: Elitza Tocheva [10.22002/D1.1566](https://doi.org/10.22002/D1.1566)'}
library(doivideo)
...
```{R 8-6b, echo=FALSE, screenshot.alt='movie_stills/8_6b.png' , fig.cap= 'Bacillus subtilis Collected by: Elitza Tocheva [10.22002/D1.1567](https://doi.org/10.22002/D1.1567)'}
library(doivideo)
...
```{R 8-7, echo=FALSE, screenshot.alt='movie_stills/8_7.png' , fig.cap= 'Bacillus subtilis Collected by: Elitza Tocheva [10.22002/D1.1559](https://doi.org/10.22002/D1.1559)'}
library(doivideo)
...
```{R 8-8, echo=FALSE, screenshot.alt='movie_stills/8_8.png' , fig.cap= 'Bacillus subtilis Collected by: Elitza Tocheva [10.22002/D1.1560](https://doi.org/10.22002/D1.1560)'}
library(doivideo)
...
```{R 8-9, echo=FALSE, screenshot.alt='movie_stills/8_9.png' , fig.cap= 'Acetonema longum Collected by: Elitza Tocheva [10.22002/D1.1561](https://doi.org/10.22002/D1.1561)'}
library(doivideo)
...
```{R 8-10, echo=FALSE, screenshot.alt='movie_stills/8_10.png' , fig.cap= 'Acetonema longum Collected by: Elitza Tocheva [10.22002/D1.1562](https://doi.org/10.22002/D1.1562)'}
library(doivideo)
...
```{R 8-10a, echo=FALSE, screenshot.alt='movie_stills/8_10a.png' , fig.cap= 'Acetonema longum Collected by: Elitza Tocheva [10.22002/D1.1568](https://doi.org/10.22002/D1.1568)'}
library(doivideo)
...
```{R 8-10b, echo=FALSE, screenshot.alt='movie_stills/8_10b.png' , fig.cap= 'Acetonema longum Collected by: Elitza Tocheva [10.22002/D1.1569](https://doi.org/10.22002/D1.1569)'}
library(doivideo)
...
```{R 8-10c, echo=FALSE, screenshot.alt='movie_stills/8_10c.png' , fig.cap= 'Sporomusa acidovorans Collected by: Elitza Tocheva [10.22002/D1.1570](https://doi.org/10.22002/D1.1570)'}
library(doivideo)
...
```{R 8-11, echo=FALSE, screenshot.alt='movie_stills/8_11.png' , fig.cap= 'Acetonema longum Collected by: Elitza Tocheva [10.22002/D1.1563](https://doi.org/10.22002/D1.1563)'}
library(doivideo)
