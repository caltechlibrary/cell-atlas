...
```{R 2-1, echo=FALSE, screenshot.alt='movie_stills/2_1.png' , fig.cap= 'Mycoplasma genitalium Collected by: [Gregory Henderson](#gregory_henderson) Movie DOI: [10.22002/D1.1350](https://doi.org/10.22002/D1.1350)'}
library(doivideo)
...
```{R 2-2, echo=FALSE, screenshot.alt='movie_stills/2_2.png' , fig.cap= 'Listeria monocytogenes Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1351](https://doi.org/10.22002/D1.1351)'}
library(doivideo)
...
```{R 2-2a, echo=FALSE, screenshot.alt='movie_stills/2_2a.png' , fig.cap= 'Bacillus subtilis Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1360](https://doi.org/10.22002/D1.1360)'}
library(doivideo)
...
```{R 2-2b, echo=FALSE, screenshot.alt='movie_stills/2_2b.png' , fig.cap= 'Methanobacterium formicicum Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1361](https://doi.org/10.22002/D1.1361)'}
library(doivideo)
...
```{R 2-3, echo=FALSE, screenshot.alt='movie_stills/2_3.png' , fig.cap= 'Hydrogenovibrio crunogenus Collected by: [Cristina Iancu](#cristina_iancu) Movie DOI: [10.22002/D1.1352](https://doi.org/10.22002/D1.1352)'}
library(doivideo)
...
```{R 2-3a, echo=FALSE, screenshot.alt='movie_stills/2_3a.png' , fig.cap= 'Escherichia coli Collected by: [Lu Gan](#lu_gan) Movie DOI: [10.22002/D1.1362](https://doi.org/10.22002/D1.1362)'}
library(doivideo)
...
```{R 2-4, echo=FALSE, screenshot.alt='movie_stills/2_4.png' , fig.cap= 'Myxococcus xanthus Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1474](https://doi.org/10.22002/D1.1474)'}
library(doivideo)
...
```{R 2-4a, echo=FALSE, screenshot.alt='movie_stills/2_4a.png' , fig.cap= 'Borrelia burgdorferi 2 Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1363](https://doi.org/10.22002/D1.1363)'}
library(doivideo)
...
```{R 2-4b, echo=FALSE, screenshot.alt='movie_stills/2_4b.png' , fig.cap= 'Borrelia burgdorferi Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1353](https://doi.org/10.22002/D1.1353)'}
library(doivideo)
...
```{R 2-4c, echo=FALSE, screenshot.alt='movie_stills/2_4c.png' , fig.cap= 'Myxococcus xanthus Collected by: [Matthew Swulius](#matthew_swulius) Movie DOI: [10.22002/D1.1364](https://doi.org/10.22002/D1.1364)'}
library(doivideo)
...
```{R 2-4d, echo=FALSE, screenshot.alt='movie_stills/2_4d.png' , fig.cap= 'Prosthecobacter debontii Collected by: [Martin Pilhofer](#martin_pilhofer) Movie DOI: [10.22002/D1.1365](https://doi.org/10.22002/D1.1365)'}
library(doivideo)
...
```{R 2-4e, echo=FALSE, screenshot.alt='movie_stills/2_4e.png' , fig.cap= 'Halomicrobium mukohataei Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1475](https://doi.org/10.22002/D1.1475)'}
library(doivideo)
...
```{R 2-5, echo=FALSE, screenshot.alt='movie_stills/2_5.png' , fig.cap= 'Mycobacterium marinum Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1354](https://doi.org/10.22002/D1.1354)'}
library(doivideo)
...
```{R 2-6, echo=FALSE, screenshot.alt='movie_stills/2_6.png' , fig.cap= 'Caulobacter crescentus Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1355](https://doi.org/10.22002/D1.1355)'}
library(doivideo)
...
```{R 2-6a, echo=FALSE, screenshot.alt='movie_stills/2_6a.png' , fig.cap= 'Delftia acidovorans Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1366](https://doi.org/10.22002/D1.1366)'}
library(doivideo)
...
```{R 2-7, echo=FALSE, screenshot.alt='movie_stills/2_7.png' , fig.cap= 'Sulfolobus solfataricus Collected by: [Lu Gan](#lu_gan) Movie DOI: [10.22002/D1.1356](https://doi.org/10.22002/D1.1356)'}
library(doivideo)
...
```{R 2-7a, echo=FALSE, screenshot.alt='movie_stills/2_7a.png' , fig.cap= 'Methylomicrobium alcaliphilum Collected by: [Songye Chen](#songye_chen) Movie DOI: [10.22002/D1.1367](https://doi.org/10.22002/D1.1367)'}
library(doivideo)
...
```{R 2-7b, echo=FALSE, screenshot.alt='movie_stills/2_7b.png' , fig.cap= 'Clostridium thermocellum Collected by: [William Nicolas](#william_nicolas) Movie DOI: [10.22002/D1.1476](https://doi.org/10.22002/D1.1476)'}
library(doivideo)
...
```{R 2-7c, echo=FALSE, screenshot.alt='movie_stills/2_7c.png' , fig.cap= 'Nitrosopumilis maritimus Collected by: [Rasika Ramdasi](#rasika_ramdasi) Movie DOI: [10.22002/D1.1368](https://doi.org/10.22002/D1.1368)'}
library(doivideo)
...
```{R 2-7d, echo=FALSE, screenshot.alt='movie_stills/2_7d.png' , fig.cap= 'Methanoregula formicica Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1369](https://doi.org/10.22002/D1.1369)'}
library(doivideo)
...
```{R 2-8, echo=FALSE, screenshot.alt='movie_stills/2_8.png' , fig.cap= 'Methanospirillum hungatei Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1357](https://doi.org/10.22002/D1.1357)'}
library(doivideo)
...
```{R 2-9, echo=FALSE, screenshot.alt='movie_stills/2_9.png' , fig.cap= 'Haloarcula argentinensis Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1358](https://doi.org/10.22002/D1.1358)'}
library(doivideo)
...
```{R 2-10, echo=FALSE, screenshot.alt='movie_stills/2_10.png' , fig.cap= 'Bdellovibrio bacteriovorus Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1359](https://doi.org/10.22002/D1.1359)'}
library(doivideo)
