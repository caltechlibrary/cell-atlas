...
(ref:2-1) Mycoplasma genitalium Collected by: [Gregory Henderson](#gregory_henderson) Movie DOI: [10.22002/D1.1350](https://doi.org/10.22002/D1.1350)

```{R 2-1, echo=FALSE, screenshot.alt='movie_stills/2_1.jpg' , fig.cap= '(ref:2-1)'}
library(doivideo)
...
(ref:2-2) Listeria monocytogenes Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1351](https://doi.org/10.22002/D1.1351)

```{R 2-2, echo=FALSE, screenshot.alt='movie_stills/2_2.jpg' , fig.cap= '(ref:2-2)'}
library(doivideo)
...
(ref:2-2a) Bacillus subtilis Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1360](https://doi.org/10.22002/D1.1360)

```{R 2-2a, echo=FALSE, screenshot.alt='movie_stills/2_2a.jpg' , fig.cap= '(ref:2-2a)'}
library(doivideo)
...
(ref:2-2b) Methanobacterium formicicum Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1361](https://doi.org/10.22002/D1.1361)

```{R 2-2b, echo=FALSE, screenshot.alt='movie_stills/2_2b.jpg' , fig.cap= '(ref:2-2b)'}
library(doivideo)
...
(ref:2-3) Hydrogenovibrio crunogenus Collected by: [Cristina Iancu](#cristina_iancu) Movie DOI: [10.22002/D1.1352](https://doi.org/10.22002/D1.1352)

```{R 2-3, echo=FALSE, screenshot.alt='movie_stills/2_3.jpg' , fig.cap= '(ref:2-3)'}
library(doivideo)
...
(ref:2-3a) Escherichia coli Collected by: [Lu Gan](#lu_gan) Movie DOI: [10.22002/D1.1362](https://doi.org/10.22002/D1.1362)

```{R 2-3a, echo=FALSE, screenshot.alt='movie_stills/2_3a.jpg' , fig.cap= '(ref:2-3a)'}
library(doivideo)
...
(ref:2-4) Myxococcus xanthus Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1474](https://doi.org/10.22002/D1.1474)

```{R 2-4, echo=FALSE, screenshot.alt='movie_stills/2_4.jpg' , fig.cap= '(ref:2-4)'}
library(doivideo)
...
(ref:2-4a) Borrelia burgdorferi 2 Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1363](https://doi.org/10.22002/D1.1363)

```{R 2-4a, echo=FALSE, screenshot.alt='movie_stills/2_4a.jpg' , fig.cap= '(ref:2-4a)'}
library(doivideo)
...
(ref:2-4b) Borrelia burgdorferi Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1353](https://doi.org/10.22002/D1.1353)

```{R 2-4b, echo=FALSE, screenshot.alt='movie_stills/2_4b.jpg' , fig.cap= '(ref:2-4b)'}
library(doivideo)
...
(ref:2-4c) Myxococcus xanthus Collected by: [Matthew Swulius](#matthew_swulius) Movie DOI: [10.22002/D1.1364](https://doi.org/10.22002/D1.1364)

```{R 2-4c, echo=FALSE, screenshot.alt='movie_stills/2_4c.jpg' , fig.cap= '(ref:2-4c)'}
library(doivideo)
...
(ref:2-4d) Prosthecobacter debontii Collected by: [Martin Pilhofer](#martin_pilhofer) Movie DOI: [10.22002/D1.1365](https://doi.org/10.22002/D1.1365)

```{R 2-4d, echo=FALSE, screenshot.alt='movie_stills/2_4d.jpg' , fig.cap= '(ref:2-4d)'}
library(doivideo)
...
(ref:2-4e) Halomicrobium mukohataei Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1475](https://doi.org/10.22002/D1.1475)

```{R 2-4e, echo=FALSE, screenshot.alt='movie_stills/2_4e.jpg' , fig.cap= '(ref:2-4e)'}
library(doivideo)
...
(ref:2-5) Mycobacterium marinum Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1354](https://doi.org/10.22002/D1.1354)

```{R 2-5, echo=FALSE, screenshot.alt='movie_stills/2_5.jpg' , fig.cap= '(ref:2-5)'}
library(doivideo)
...
(ref:2-6) Caulobacter crescentus Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1355](https://doi.org/10.22002/D1.1355)

```{R 2-6, echo=FALSE, screenshot.alt='movie_stills/2_6.jpg' , fig.cap= '(ref:2-6)'}
library(doivideo)
...
(ref:2-6a) Delftia acidovorans Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1366](https://doi.org/10.22002/D1.1366)

```{R 2-6a, echo=FALSE, screenshot.alt='movie_stills/2_6a.jpg' , fig.cap= '(ref:2-6a)'}
library(doivideo)
...
(ref:2-7) Sulfolobus solfataricus Collected by: [Lu Gan](#lu_gan) Movie DOI: [10.22002/D1.1356](https://doi.org/10.22002/D1.1356)

```{R 2-7, echo=FALSE, screenshot.alt='movie_stills/2_7.jpg' , fig.cap= '(ref:2-7)'}
library(doivideo)
doivideo('10.22002/D1.1356',0)
```

### Methylomicrobium alcaliphilum{#Methylomicrobium_alcaliphilum}
...
(ref:2-7a) Methylomicrobium alcaliphilum Collected by: [Songye Chen](#songye_chen) Movie DOI: [10.22002/D1.1367](https://doi.org/10.22002/D1.1367)

```{R 2-7a, echo=FALSE, screenshot.alt='movie_stills/2_7a.jpg' , fig.cap= '(ref:2-7a)'}
library(doivideo)
...
(ref:2-7b) Clostridium thermocellum Collected by: [William Nicolas](#william_nicolas) Movie DOI: [10.22002/D1.1476](https://doi.org/10.22002/D1.1476)

```{R 2-7b, echo=FALSE, screenshot.alt='movie_stills/2_7b.jpg' , fig.cap= '(ref:2-7b)'}
library(doivideo)
doivideo('10.22002/D1.1476',0)
```

### Nitrosopumilus maritimus{#Nitrosopumilus_maritimus}
In *Nitrosopumilus maritimus*, surface layer proteins form hexagonal rosettes that in turn pack into a hexagonal lattice.

(ref:2-7c) Nitrosopumilis maritimus Collected by: [Rasika Ramdasi](#rasika_ramdasi) Movie DOI: [10.22002/D1.1368](https://doi.org/10.22002/D1.1368)

```{R 2-7c, echo=FALSE, screenshot.alt='movie_stills/2_7c.jpg' , fig.cap= '(ref:2-7c)'}
library(doivideo)
...
(ref:2-7d) Methanoregula formicica Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1369](https://doi.org/10.22002/D1.1369)

```{R 2-7d, echo=FALSE, screenshot.alt='movie_stills/2_7d.jpg' , fig.cap= '(ref:2-7d)'}
library(doivideo)
...
(ref:2-8) Methanospirillum hungatei Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1357](https://doi.org/10.22002/D1.1357)

```{R 2-8, echo=FALSE, screenshot.alt='movie_stills/2_8.jpg' , fig.cap= '(ref:2-8)'}
library(doivideo)
...
(ref:2-9) Haloarcula argentinensis Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1358](https://doi.org/10.22002/D1.1358)

```{R 2-9, echo=FALSE, screenshot.alt='movie_stills/2_9.jpg' , fig.cap= '(ref:2-9)'}
library(doivideo)
...
(ref:2-10) Bdellovibrio bacteriovorus Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1359](https://doi.org/10.22002/D1.1359)

```{R 2-10, echo=FALSE, screenshot.alt='movie_stills/2_10.jpg' , fig.cap= '(ref:2-10)'}
library(doivideo)
