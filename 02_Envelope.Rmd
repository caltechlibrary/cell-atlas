...
```{R 10.22002/1350, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1350',0)
```

### Lipid bilayer
```{R 2-1-1, fig.cap="Lipid bilayer"}
...
```{R 2-1-2, fig.cap="ATP synthase and energy production"}
...
In monoderm bacteria like this Listeria monocytogenes, the cell wall is significantly thicker than the membrane. It comprises several layers of peptidoglycan, which can't be seen individually at the resolution of this image, so the cell wall appears as a uniformly textured layer [More: Peptidoglycan architecture](#Peptidoglycan_architecture). It's still a mystery how large molecules can pass through this dense layer on their way to and from the cell. Not all bacterial cell walls are chemically identical [More: Methanobacterium formicicum](#). And in some conditions, cells can lose their walls [More: L-form bacteria](#).

```{R 10.22002/1351, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1351',0)
```
...
```{R 10.22002/1360, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1360',0)
```

### L-form bacteria
```{R 2-2-1, fig.cap="L-form bacteria"}
...
Compared to the inner membrane, the outer membrane has some unique properties! It is more permeable and not proton-tight (so it can't be used to generate ATP). It is often asymmetric, with a different composition of lipids and proteins in each of the two leaflets. The outer membrane is anchored to the sacculus [Schematic – Braun's lipoprotein](#fig:2-3-1). And the sacculus itself is different. Rather than containing many layers of peptidoglycan like in the Listeria monocytogenes cell you just saw, the diderm sacculus consists largely of a single-layered peptidoglycan mesh [More: Diderm sacculus architecture](#Diderm_sacculus_architecture), which you can see here as a thin line in the periplasm. This difference in the sacculus enables a well-known bacterial classification system: the Gram stain, which binds peptidoglycan. Gram-positive cells, typically monoderm, contain much more peptidoglycan than Gram-negative cells, which are typically diderm. Thinking about this thin defense against turgor pressure underscores a major challenge for cell growth. To insert new material, existing bonds in the sacculus must be broken, without bursting the cell in the process [Schematic – Sacculus remodeling](#fig:2-3-2).

```{R 10.22002/1352, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1352',0)
```

### Braun's lipoprotein
```{R 2-3-1, fig.cap="Braun's lipoprotein"}
...
```{R 10.22002/1362, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1362',0)
```

### Sacculus remodeling
```{R 2-3-2, fig.cap="Sacculus remodeling"}
...
```{R 10.22002/1353, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1353',0)
```
...
```{R 10.22002/1363, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1363',0)
```
...
```{R 10.22002/1364, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1364',0)
```
...
```{R 10.22002/1354, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1354',0)
```

### Mycobacterial architecture
```{R 2-5-1, fig.cap="Mycobacterial architecture"}
...
S-layers are crystalline lattices, and they can be striking in appearance, as on this Caulobacter crescentus cell. Amazingly, the lattice is made from (many copies of) a single protein [Schematic – S-layer architecture](#fig:2-6-1). The pinwheel-like subunits interact laterally, leaving pores large enough for nutrients to pass through, but not large enough for viruses. The modular nature of the lattice means that units can be popped in as the cell grows, or popped out to allow a cell appendage to poke through. In general, S-layers are quite accommodating; they don't even interfere with the production of outer membrane vesicles [More: Nanopods](#Nanopods). S-layer proteins can also be modified to alter their properties; for instance attachment of a sugar can enable them to stick the cell to a surface.

```{R 10.22002/1355, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1355',0)
```

### S-layer architecture
```{R 2-6-1, fig.cap="S-layer architecture"}
...
```{R 10.22002/1366, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1366',0)
```
...
```{R 10.22002/1356, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1356',0)
```
...
```{R 10.22002/1367, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1367',0)
```
...
```{R 10.22002/1368, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1368',0)
```
...
```{R 10.22002/1369, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1369',0)
```
...
```{R 10.22002/1357, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1357',0)
```
...
```{R 10.22002/1358, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1358',0)
```
...
```{R 10.22002/1359, echo=FALSE, screenshot.alt='img/02_static/2_1_Mgenitalium.jpg'}
library(doivideo)
doivideo('10.22002/1359',0)
```
