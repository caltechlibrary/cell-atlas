...
```{R 4-1, echo=FALSE, screenshot.alt='movie_stills/4_1.png' , fig.cap= 'Caulobacter crescentus Collected by: [Zhuo Li](#zhuo_li) Movie DOI: [10.22002/D1.1489](https://doi.org/10.22002/D1.1489)'}
library(doivideo)
...
```{R 4-2, echo=FALSE, screenshot.alt='movie_stills/4_2.png' , fig.cap= 'Shewanella oneidensis Collected by: [Poorna Subramanian](#poorna_subramanian) Movie DOI: [10.22002/D1.1490](https://doi.org/10.22002/D1.1490)'}
library(doivideo)
...
```{R 4-3, echo=FALSE, screenshot.alt='movie_stills/4_3.png' , fig.cap= 'Rhodopseudomonas palustris Collected by: [Alasdair McDowall](#alasdair_mcdowall) Movie DOI: [10.22002/D1.1491](https://doi.org/10.22002/D1.1491)'}
library(doivideo)
...
```{R 4-3a, echo=FALSE, screenshot.alt='movie_stills/4_3a.png' , fig.cap= 'Methyloprofundus sedimenti Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1499](https://doi.org/10.22002/D1.1499)'}
library(doivideo)
...
```{R 4-4, echo=FALSE, screenshot.alt='movie_stills/4_4.png' , fig.cap= 'Chloroflexi Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1492](https://doi.org/10.22002/D1.1492)'}
library(doivideo)
...
```{R 4-5, echo=FALSE, screenshot.alt='movie_stills/4_5.png' , fig.cap= 'Clostridium thermocellum Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1493](https://doi.org/10.22002/D1.1493)'}
library(doivideo)
...
```{R 4-6, echo=FALSE, screenshot.alt='movie_stills/4_6.png' , fig.cap= 'Acetonema longum Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1494](https://doi.org/10.22002/D1.1494)'}
library(doivideo)
...
```{R 4-7, echo=FALSE, screenshot.alt='movie_stills/4_7.png' , fig.cap= 'Thiomonas intermedia Collected by: [Cristina Iancu](#cristina_iancu) Movie DOI: [10.22002/D1.1495](https://doi.org/10.22002/D1.1495)'}
library(doivideo)
...
```{R 4-7a, echo=FALSE, screenshot.alt='movie_stills/4_7a.png' , fig.cap= 'Halothiobacillus neapolitanus Collected by: [Cristina Iancu](#cristina_iancu) Movie DOI: [10.22002/D1.1500](https://doi.org/10.22002/D1.1500)'}
library(doivideo)
...
```{R 4-7b, echo=FALSE, screenshot.alt='movie_stills/4_7b.png' , fig.cap= 'Hydrogenovibrio crunogenus Collected by: [Cristina Iancu](#cristina_iancu) Movie DOI: [10.22002/D1.1501](https://doi.org/10.22002/D1.1501)'}
library(doivideo)
...
```{R 4-8, echo=FALSE, screenshot.alt='movie_stills/4_8.png' , fig.cap= 'Cupriavidus necator Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1496](https://doi.org/10.22002/D1.1496)'}
library(doivideo)
...
```{R 4-8a, echo=FALSE, screenshot.alt='movie_stills/4_8a.png' , fig.cap= 'Lysobacter antibioticus Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1502](https://doi.org/10.22002/D1.1502)'}
library(doivideo)
...
```{R 4-9, echo=FALSE, screenshot.alt='movie_stills/4_9.png' , fig.cap= 'Agrobacterium tumefaciens Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1497](https://doi.org/10.22002/D1.1497)'}
library(doivideo)
...
```{R 4-9a, echo=FALSE, screenshot.alt='movie_stills/4_9a.png' , fig.cap= 'Hydrogenovibrio crunogenus Collected by: [Cristina Iancu](#cristina_iancu) Movie DOI: [10.22002/D1.1503](https://doi.org/10.22002/D1.1503)'}
library(doivideo)
...
```{R 4-9b, echo=FALSE, screenshot.alt='movie_stills/4_9b.png' , fig.cap= 'Halothiobacillus neapolitanus Collected by: [Cristina Iancu](#cristina_iancu) Movie DOI: [10.22002/D1.1504](https://doi.org/10.22002/D1.1504)'}
library(doivideo)
...
```{R 4-10, echo=FALSE, screenshot.alt='movie_stills/4_10.png' , fig.cap= 'Halorubrum litoreum Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1498](https://doi.org/10.22002/D1.1498)'}
library(doivideo)
...
```{R 4-10a, echo=FALSE, screenshot.alt='movie_stills/4_10a.png' , fig.cap= 'Haloferax gibbonsii Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1505](https://doi.org/10.22002/D1.1505)'}
library(doivideo)
...
```{R 4-10b, echo=FALSE, screenshot.alt='movie_stills/4_10b.png' , fig.cap= 'Halohasta litchfieldiae Collected by: [Zhuo Li](#zhuo_li) Movie DOI: [10.22002/D1.1506](https://doi.org/10.22002/D1.1506)'}
library(doivideo)
