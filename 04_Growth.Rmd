...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_1_Ccrescentus.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_2_Soneidensis.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_3_Rpalustris.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_3a_Msedimenti.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_5_Cthermocellum.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_6_Alongum.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_7_Tintermedia.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_7a_Hneapolitanus.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_7b_Hcrunogenus.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_8_Cnecator.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_8a_Lantibioticus.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_9_Atumefaciens.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_9a_Hcrunogenus.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_9b_Hneapolitanus.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_10_Hlitoreum.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_10a_Hgibbonsii.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/4_10b_Hlitchfieldiae.mp4')
} else {
library(doivideo)
