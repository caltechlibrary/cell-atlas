...
Archaea also use storage granules, and you will see many examples throughout the book. Compared to the typically-smooth edges of bacterial granules, the edges of many archaeal granules are spikier, giving them a rougher appearance, as in this *Halorubrum litoreum* cell. Others are smooth and, just like in bacteria, they exhibit a range of morphologies depending on what they store. For instance, compare [More: *Haloferax gibbonsii* granules](#*Haloferax_gibbonsii*_granules) and [More: *Halohasta litchfieldiae* granules](#*Halohasta_litchfieldiae*_granules).
...
### More: *Haloferax gibbonsii* granules{-#*Haloferax_gibbonsii*_granules}
...
### More: *Halohasta litchfieldiae* granules{-#*Halohasta_litchfieldiae*_granules}
