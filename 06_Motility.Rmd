...
```{R 6-1, echo=FALSE, screenshot.alt='movie_stills/6_1.png' , fig.cap= 'Campylobacter jejuni Collected by: Morgan Beeby [10.22002/D1.1525](https://doi.org/10.22002/D1.1525)'}
library(doivideo)
...
```{R 6-2, echo=FALSE, screenshot.alt='movie_stills/6_2.png' , fig.cap= 'Bdellovibrio bacteriovorus Collected by: Yi-Wei Chang [10.22002/D1.1526](https://doi.org/10.22002/D1.1526)'}
library(doivideo)
...
```{R 6-2a, echo=FALSE, screenshot.alt='movie_stills/6_2a.png' , fig.cap= 'Bdellovibrio bacteriovorus Collected by: Yi-Wei Chang [10.22002/D1.1537](https://doi.org/10.22002/D1.1537)'}
library(doivideo)
...
```{R 6-3, echo=FALSE, screenshot.alt='movie_stills/6_3.png' , fig.cap= 'Hylemonella gracilis Collected by: Yi-Wei Chang [10.22002/D1.1527](https://doi.org/10.22002/D1.1527)'}
library(doivideo)
...
```{R 6-3a, echo=FALSE, screenshot.alt='movie_stills/6_3a.png' , fig.cap= 'Pseudomonas aeruginosa Collected by: Ariane Briegel [10.22002/D1.1538](https://doi.org/10.22002/D1.1538)'}
library(doivideo)
...
```{R 6-4, echo=FALSE, screenshot.alt='movie_stills/6_4.png' , fig.cap= 'Campylobacter jejuni Collected by: Morgan Beeby [10.22002/D1.1528](https://doi.org/10.22002/D1.1528)'}
library(doivideo)
...
```{R 6-4a, echo=FALSE, screenshot.alt='movie_stills/6_4a.png' , fig.cap= 'Helicobacter pylori Collected by: Yi-Wei Chang [10.22002/D1.1539](https://doi.org/10.22002/D1.1539)'}
library(doivideo)
...
```{R 6-5, echo=FALSE, screenshot.alt='movie_stills/6_5.png' , fig.cap= 'Pseudomonas flexibilis Collected by: Morgan Beeby [10.22002/D1.1529](https://doi.org/10.22002/D1.1529)'}
library(doivideo)
...
```{R 6-5a, echo=FALSE, screenshot.alt='movie_stills/6_5a.png' , fig.cap= 'Proteus mirabilis Collected by: Qing Yao [10.22002/D1.1540](https://doi.org/10.22002/D1.1540)'}
library(doivideo)
...
```{R 6-6, echo=FALSE, screenshot.alt='movie_stills/6_6.png' , fig.cap= 'Helicobacter hepaticus Collected by: Ariane Briegel [10.22002/D1.1530](https://doi.org/10.22002/D1.1530)'}
library(doivideo)
...
```{R 6-7, echo=FALSE, screenshot.alt='movie_stills/6_7.png' , fig.cap= 'Borrelia burgdorferi Collected by: Ariane Briegel [10.22002/D1.1531](https://doi.org/10.22002/D1.1531)'}
library(doivideo)
...
```{R 6-7a, echo=FALSE, screenshot.alt='movie_stills/6_7a.png' , fig.cap= 'Treponema primitia Collected by: Gavin Murphy [10.22002/D1.1541](https://doi.org/10.22002/D1.1541)'}
library(doivideo)
...
```{R 6-8, echo=FALSE, screenshot.alt='movie_stills/6_8.png' , fig.cap= 'Methanoregula formicica Collected by: Ariane Briegel [10.22002/D1.1532](https://doi.org/10.22002/D1.1532)'}
library(doivideo)
...
```{R 6-9, echo=FALSE, screenshot.alt='movie_stills/6_9.png' , fig.cap= 'Thermococcus kodakaraensis Collected by: Ariane Briegel [10.22002/D1.1533](https://doi.org/10.22002/D1.1533)'}
library(doivideo)
...
```{R 6-9a, echo=FALSE, screenshot.alt='movie_stills/6_9a.png' , fig.cap= 'Thermococcus kodakaraensis Collected by: Ariane Briegel [10.22002/D1.1542](https://doi.org/10.22002/D1.1542)'}
library(doivideo)
...
```{R 6-9b, echo=FALSE, screenshot.alt='movie_stills/6_9b.png' , fig.cap= 'Thermococcus kodakaraensis Collected by: Ariane Briegel [10.22002/D1.1543](https://doi.org/10.22002/D1.1543)'}
library(doivideo)
...
```{R 6-10, echo=FALSE, screenshot.alt='movie_stills/6_10.png' , fig.cap= 'Myxococcus xanthus Collected by: Yi-Wei Chang [10.22002/D1.1534](https://doi.org/10.22002/D1.1534)'}
library(doivideo)
...
```{R 6-11, echo=FALSE, screenshot.alt='movie_stills/6_11.png' , fig.cap= 'Flavobacterium johnsoniae Collected by: Gregory Henderson [10.22002/D1.1535](https://doi.org/10.22002/D1.1535)'}
library(doivideo)
...
```{R 6-12, echo=FALSE, screenshot.alt='movie_stills/6_12.png' , fig.cap= 'Mycoplasma pneumoniae Collected by: Gregory Henderson [10.22002/D1.1536](https://doi.org/10.22002/D1.1536)'}
library(doivideo)
