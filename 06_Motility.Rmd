...
While the basic plan of the motor is the same in every species that has flagella, there are structural differences that reflect the different environments species encounter [Schematic: Flagellar motor diversity](#Flagellar_motor_diversity).
