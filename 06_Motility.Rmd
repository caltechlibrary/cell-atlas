...
Nearly all bacteria that swim use the same propeller: a rotary motor embedded in their envelope that spins a long helical fiber called a **flagellum** [Schematic: Flagellum structure](#Flagellum_structure). A universal joint called the hook connects the filament to the motor, translating the rotation. Flagella, like the one on this *Campylobacter jejuni*, are typically many times longer than the cell and take the form of a three-dimensional wave. The filament is highly dynamic, as you would expect, and throughout this book, you will see examples caught in various conformations: straight, curved, or in a typical loose helical waveform like this.

(ref:6-1) [Campylobacter jejuni](#tree) Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1525](https://doi.org/10.22002/D1.1525)

```{R 6-1, echo=FALSE, screenshot.alt='movie_stills/6_1.png' , fig.cap= '(ref:6-1)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_1_Cjejuni_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1525',0,'movie_stills/6_1.png')}
```

### Schematic: Flagellum structure {-#Flagellum_structure}
```{R}
knitr::include_graphics('img/schematics/6_1_1.gif')
```

[*PDB: 5WJT*](http://rcsb.org/structure/5WJT)
...
While the basic plan of the motor is the same in different species, there are structural differences that reflect the different environments those species encounter [Schematic: Flagellar motor diversity](#Flagellar_motor_diversity).

(ref:6-2) [Bdellovibrio bacteriovorus](#tree) Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1526](https://doi.org/10.22002/D1.1526)

```{R 6-2, echo=FALSE, screenshot.alt='movie_stills/6_2.png' , fig.cap= '(ref:6-2)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_2_Bbacteriovorus_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1526',0,'movie_stills/6_2.png')}
```

### More: Flagellar motor structure{-#Flagellar_motor_structure}
This is an average of the flagellar motors from more than one thousand *Bdellovibrio bacteriovorus* cells. Working upward from the base, the major parts of the rotor are the C-ring (for <u>C</u>ytoplasmic), the MS-ring (for <u>M</u>embrane and <u>S</u>upramembrane), the rod, the hook, and finally the filament. They are surrounded by stationary parts: the stator ring (which is dynamic, with various conformations that wash out when averaged, so we cannot resolve the stators as they cross the inner membrane and connect to the C-ring) and a series of bushings that allow rotation within the cell wall (the <u>P</u>eriplasmic or P-ring) and outer membrane (<u>L</u>ipopolysaccharide or L-ring). Additional cytoplasmic components form the export apparatus, which is involved in assembly (discussed on the next page).

(ref:6-2a) [Bdellovibrio bacteriovorus](#tree) Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1537](https://doi.org/10.22002/D1.1537)

```{R 6-2a, echo=FALSE, screenshot.alt='movie_stills/6_2a.png' , fig.cap= '(ref:6-2a)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_2a_Bbacteriovorus_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1537',0,'movie_stills/6_2a.png')}
```

### Schematic: Flagellar motor diversity {-#Flagellar_motor_diversity}
```{R}
...
(ref:6-3) [Hylemonella gracilis](#tree) Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1527](https://doi.org/10.22002/D1.1527)

```{R 6-3, echo=FALSE, screenshot.alt='movie_stills/6_3.png' , fig.cap= '(ref:6-3)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_3_Hgracilis_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1527',0,'movie_stills/6_3.png')}
```

### More: Flagellar motor disassembly{-#Flagellar_motor_disassembly}
...
(ref:6-3a) [Pseudomonas aeruginosa](#tree) Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1538](https://doi.org/10.22002/D1.1538)

```{R 6-3a, echo=FALSE, screenshot.alt='movie_stills/6_3a.png' , fig.cap= '(ref:6-3a)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_3a_Paeruginosa_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1538',0,'movie_stills/6_3a.png')}
```
...
(ref:6-4) [Campylobacter jejuni](#tree) Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1528](https://doi.org/10.22002/D1.1528)

```{R 6-4, echo=FALSE, screenshot.alt='movie_stills/6_4.png' , fig.cap= '(ref:6-4)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_4_Cjejuni_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1528',0,'movie_stills/6_4.png')}
```

### More: Lophotrichous bacteria{-#Lophotrichous_bacteria}
...
(ref:6-4a) [Helicobacter pylori](#tree) Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1539](https://doi.org/10.22002/D1.1539)

```{R 6-4a, echo=FALSE, screenshot.alt='movie_stills/6_4a.png' , fig.cap= '(ref:6-4a)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_4a_Hpylori_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1539',0,'movie_stills/6_4a.png')}
```
...
(ref:6-5) [Pseudomonas flexibilis](#tree) Collected by: [Morgan Beeby](#morgan_beeby) Movie DOI: [10.22002/D1.1529](https://doi.org/10.22002/D1.1529)

```{R 6-5, echo=FALSE, screenshot.alt='movie_stills/6_5.png' , fig.cap= '(ref:6-5)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_5_Pflexibilis_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1529',0,'movie_stills/6_5.png')}
```

### More: Proteus mirabilis flagella{-#Proteus_mirabilis_flagella}
...
(ref:6-5a) [Proteus mirabilis](#tree) Collected by: [Qing Yao](#qing_yao) Movie DOI: [10.22002/D1.1540](https://doi.org/10.22002/D1.1540)

```{R 6-5a, echo=FALSE, screenshot.alt='movie_stills/6_5a.png' , fig.cap= '(ref:6-5a)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_5a_Pmirabilis_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1540',0,'movie_stills/6_5a.png')}
```
...
(ref:6-6) [Helicobacter hepaticus](#tree) Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1530](https://doi.org/10.22002/D1.1530)

```{R 6-6, echo=FALSE, screenshot.alt='movie_stills/6_6.png' , fig.cap= '(ref:6-6)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_6_Hhepaticus_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1530',0,'movie_stills/6_6.png')}
```
...
(ref:6-7) [Borrelia burgdorferi](#tree) Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1531](https://doi.org/10.22002/D1.1531)

```{R 6-7, echo=FALSE, screenshot.alt='movie_stills/6_7.png' , fig.cap= '(ref:6-7)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_7_Bburgdorferi_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1531',0,'movie_stills/6_7.png')}
```

### More: Treponema primitia{-#Treponema_primitia}
...
A leveraging plate must not be essential, however, because not all lophotrichous archaea use one [More: Lophotrichous Halobacteria](#Lophotrichous_Halobacteria).

(ref:6-9) [Thermococcus kodakaraensis](#tree) Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1533](https://doi.org/10.22002/D1.1533)

```{R 6-9, echo=FALSE, screenshot.alt='movie_stills/6_9.png' , fig.cap= '(ref:6-9)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_9_Tkodakaraensis_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1533',0,'movie_stills/6_9.png')}
```

### More: Cone structure{-#Cone_structure}
...
(ref:6-9a) [Thermococcus kodakaraensis](#tree) Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1542](https://doi.org/10.22002/D1.1542)

```{R 6-9a, echo=FALSE, screenshot.alt='movie_stills/6_9a.png' , fig.cap= '(ref:6-9a)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_9a_Tkodakaraensis_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1542',0,'movie_stills/6_9a.png')}
```

### More: Organizing center{-#Organizing_center}
...
(ref:6-9b) [Thermococcus kodakaraensis](#tree) Collected by: [Ariane Briegel](#ariane_briegel) Movie DOI: [10.22002/D1.1543](https://doi.org/10.22002/D1.1543)

```{R 6-9b, echo=FALSE, screenshot.alt='movie_stills/6_9b.png' , fig.cap= '(ref:6-9b)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_9b_Tkodakaraensis_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1543',0,'movie_stills/6_9b.png')}
```

### More: Lophotrichous Halobacteria{-#Lophotrichous_Halobacteria}
...
(ref:6-10) [Myxococcus xanthus](#tree) Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1534](https://doi.org/10.22002/D1.1534)

```{R 6-10, echo=FALSE, screenshot.alt='movie_stills/6_10.png' , fig.cap= '(ref:6-10)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_10_Mxanthus_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1534',0,'movie_stills/6_10.png')}
```

### Schematic: Type IV pilus structure {-#Type_IV_pilus_structure}
```{R}
...
(ref:6-11) [Flavobacterium johnsoniae](#tree) Collected by: [Gregory Henderson](#gregory_henderson) Movie DOI: [10.22002/D1.1535](https://doi.org/10.22002/D1.1535)

```{R 6-11, echo=FALSE, screenshot.alt='movie_stills/6_11.png' , fig.cap= '(ref:6-11)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_11_Fjohnsoniae_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1535',0,'movie_stills/6_11.png')}
```
...
(ref:6-12) [Mycoplasma pneumoniae](#tree) Collected by: [Gregory Henderson](#gregory_henderson) Movie DOI: [10.22002/D1.1536](https://doi.org/10.22002/D1.1536)

```{R 6-12, echo=FALSE, screenshot.alt='movie_stills/6_12.png' , fig.cap= '(ref:6-12)'}
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/6_12_Mpneumoniae_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1536',0,'movie_stills/6_12.png')}
```

## Summary {#summary6}

```{R}
knitr::include_graphics('img/summaries/06_Motility.gif')
```
