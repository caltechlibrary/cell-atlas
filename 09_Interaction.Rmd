...
T3SSs are closely related to type II secretion systems (T2SSs) and share a common element: the channel embedded in the outer membrane, formed by many copies of a protein called a Secretin [Schematic: Secretin structure](#Secretin_structure). As you can see, though, the rest of the machine looks very different.
...
### Schematic: Secretin structure {-#Secretin_structure}
```{R}
