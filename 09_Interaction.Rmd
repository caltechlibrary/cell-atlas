...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_1_Atumefaciens_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1571',0,'movie_stills/9_1.png')}
```
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_2_Ghansenii_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1572',0,'movie_stills/9_2.png')}
```
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_3_Lpneumophila_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1573',0,'movie_stills/9_3.png')}
```
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_3a_Hpylori_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1582',0,'movie_stills/9_3a.png')}
```
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_4_Paeruginosa_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1574',0,'movie_stills/9_4.png')}
```
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_5_Ecoli_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1575',0,'movie_stills/9_5.png')}
```
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_6_Mxanthus_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1576',0,'movie_stills/9_6.png')}
```
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_7_Vcholerae_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1577',0,'movie_stills/9_7.png')}
```
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_7a_Aasiaticus_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1583',0,'movie_stills/9_7a.png')}
```
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_7b_Pluteoviolacea_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1584',0,'movie_stills/9_7b.png')}
```
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_8_Pgingivalis_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1578',0,'movie_stills/9_8.png')}
```
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_9_BbacteriovorusVcholerae_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1579',0,'movie_stills/9_9.png')}
```
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_10_BbacteriovorusEcoli_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1580',0,'movie_stills/9_10.png')}
```
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_10a_BbacteriovorusEcoli_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1585',0,'movie_stills/9_10a.png')}
```
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/9_11_BbacteriovorusVcholerae_480p.mp4')
} else {
library(doivideo)
doivideo('10.22002/D1.1581',0,'movie_stills/9_11.png')}
```
