...
```{R 9-1, echo=FALSE, screenshot.alt='movie_stills/9_1.png' , fig.cap= 'Agrobacterium tumefaciens Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1571](https://doi.org/10.22002/D1.1571)'}
library(doivideo)
...
```{R 9-2, echo=FALSE, screenshot.alt='movie_stills/9_2.png' , fig.cap= 'Gluconacetobacter hansenii Collected by: [William Nicolas](#william_nicolas) Movie DOI: [10.22002/D1.1572](https://doi.org/10.22002/D1.1572)'}
library(doivideo)
...
```{R 9-3, echo=FALSE, screenshot.alt='movie_stills/9_3.png' , fig.cap= 'Legionella pneumophila Collected by: [Debnath Ghosal](#debnath_ghosal) Movie DOI: [10.22002/D1.1573](https://doi.org/10.22002/D1.1573)'}
library(doivideo)
...
```{R 9-3a, echo=FALSE, screenshot.alt='movie_stills/9_3a.png' , fig.cap= 'Helicobacter pylori Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1582](https://doi.org/10.22002/D1.1582)'}
library(doivideo)
...
```{R 9-4, echo=FALSE, screenshot.alt='movie_stills/9_4.png' , fig.cap= 'Pseudomonas aeruginosa Collected by: [Steven Wang](#steven_wang) Movie DOI: [10.22002/D1.1574](https://doi.org/10.22002/D1.1574)'}
library(doivideo)
...
```{R 9-5, echo=FALSE, screenshot.alt='movie_stills/9_5.png' , fig.cap= 'Escherichia coli Collected by: [Poorna Subramanian](#poorna_subramanian) Movie DOI: [10.22002/D1.1575](https://doi.org/10.22002/D1.1575)'}
library(doivideo)
...
```{R 9-6, echo=FALSE, screenshot.alt='movie_stills/9_6.png' , fig.cap= 'Myxococcus xanthus Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1576](https://doi.org/10.22002/D1.1576)'}
library(doivideo)
...
```{R 9-7, echo=FALSE, screenshot.alt='movie_stills/9_7.png' , fig.cap= 'Vibrio cholerae Collected by: [Martin Pilhofer](#martin_pilhofer) Movie DOI: [10.22002/D1.1577](https://doi.org/10.22002/D1.1577)'}
library(doivideo)
...
```{R 9-7a, echo=FALSE, screenshot.alt='movie_stills/9_7a.png' , fig.cap= 'Amoebophilus asiaticus Collected by: [Martin Pilhofer](#martin_pilhofer) Movie DOI: [10.22002/D1.1583](https://doi.org/10.22002/D1.1583)'}
library(doivideo)
...
```{R 9-7b, echo=FALSE, screenshot.alt='movie_stills/9_7b.png' , fig.cap= 'Pseudoalteromonas luteoviolacea Collected by: [Martin Pilhofer](#martin_pilhofer) Movie DOI: [10.22002/D1.1584](https://doi.org/10.22002/D1.1584)'}
library(doivideo)
...
```{R 9-8, echo=FALSE, screenshot.alt='movie_stills/9_8.png' , fig.cap= 'Porphyromonas gingivalis Collected by: [Poorna Subramanian](#poorna_subramanian) Movie DOI: [10.22002/D1.1578](https://doi.org/10.22002/D1.1578)'}
library(doivideo)
...
```{R 9-9, echo=FALSE, screenshot.alt='movie_stills/9_9.png' , fig.cap= 'Bdellovibrio bacteriovorus / Vibrio cholerae Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1579](https://doi.org/10.22002/D1.1579)'}
library(doivideo)
...
```{R 9-10, echo=FALSE, screenshot.alt='movie_stills/9_10.png' , fig.cap= 'Bdellovibrio bacteriovorus / Escherichia coli Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1580](https://doi.org/10.22002/D1.1580)'}
library(doivideo)
...
```{R 9-10a, echo=FALSE, screenshot.alt='movie_stills/9_10a.png' , fig.cap= 'Bdellovibrio bacteriovorus / Escherichia coli Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1585](https://doi.org/10.22002/D1.1585)'}
library(doivideo)
...
```{R 9-11, echo=FALSE, screenshot.alt='movie_stills/9_11.png' , fig.cap= 'Bdellovibrio bacteriovorus / Vibrio cholerae Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1581](https://doi.org/10.22002/D1.1581)'}
library(doivideo)
