...
(ref:9-1) Agrobacterium tumefaciens Collected by: [Elitza Tocheva](#elitza_tocheva) Movie DOI: [10.22002/D1.1571](https://doi.org/10.22002/D1.1571)

```{R 9-1, echo=FALSE, screenshot.alt='movie_stills/9_1.jpg' , fig.cap= '(ref:9-1)'}
library(doivideo)
...
(ref:9-2) Gluconacetobacter hansenii Collected by: [William Nicolas](#william_nicolas) Movie DOI: [10.22002/D1.1572](https://doi.org/10.22002/D1.1572)

```{R 9-2, echo=FALSE, screenshot.alt='movie_stills/9_2.jpg' , fig.cap= '(ref:9-2)'}
library(doivideo)
...
(ref:9-3) Legionella pneumophila Collected by: [Debnath Ghosal](#debnath_ghosal) Movie DOI: [10.22002/D1.1573](https://doi.org/10.22002/D1.1573)

```{R 9-3, echo=FALSE, screenshot.alt='movie_stills/9_3.jpg' , fig.cap= '(ref:9-3)'}
library(doivideo)
...
### Helicobacter pylori tubes{#Helicobacter_pylori_tubes}
...
(ref:9-3a) Helicobacter pylori Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1582](https://doi.org/10.22002/D1.1582)

```{R 9-3a, echo=FALSE, screenshot.alt='movie_stills/9_3a.jpg' , fig.cap= '(ref:9-3a)'}
library(doivideo)
...
(ref:9-4) Pseudomonas aeruginosa Collected by: [Steven Wang](#steven_wang) Movie DOI: [10.22002/D1.1574](https://doi.org/10.22002/D1.1574)

```{R 9-4, echo=FALSE, screenshot.alt='movie_stills/9_4.jpg' , fig.cap= '(ref:9-4)'}
library(doivideo)
...
(ref:9-5) Escherichia coli Collected by: [Poorna Subramanian](#poorna_subramanian) Movie DOI: [10.22002/D1.1575](https://doi.org/10.22002/D1.1575)

```{R 9-5, echo=FALSE, screenshot.alt='movie_stills/9_5.jpg' , fig.cap= '(ref:9-5)'}
library(doivideo)
...
(ref:9-6) Myxococcus xanthus Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1576](https://doi.org/10.22002/D1.1576)

```{R 9-6, echo=FALSE, screenshot.alt='movie_stills/9_6.jpg' , fig.cap= '(ref:9-6)'}
library(doivideo)
...
(ref:9-7) Vibrio cholerae Collected by: [Martin Pilhofer](#martin_pilhofer) Movie DOI: [10.22002/D1.1577](https://doi.org/10.22002/D1.1577)

```{R 9-7, echo=FALSE, screenshot.alt='movie_stills/9_7.jpg' , fig.cap= '(ref:9-7)'}
library(doivideo)
...
(ref:9-7a) Amoebophilus asiaticus Collected by: [Martin Pilhofer](#martin_pilhofer) Movie DOI: [10.22002/D1.1583](https://doi.org/10.22002/D1.1583)

```{R 9-7a, echo=FALSE, screenshot.alt='movie_stills/9_7a.jpg' , fig.cap= '(ref:9-7a)'}
library(doivideo)
...
(ref:9-7b) Pseudoalteromonas luteoviolacea Collected by: [Martin Pilhofer](#martin_pilhofer) Movie DOI: [10.22002/D1.1584](https://doi.org/10.22002/D1.1584)

```{R 9-7b, echo=FALSE, screenshot.alt='movie_stills/9_7b.jpg' , fig.cap= '(ref:9-7b)'}
library(doivideo)
...
(ref:9-8) Porphyromonas gingivalis Collected by: [Poorna Subramanian](#poorna_subramanian) Movie DOI: [10.22002/D1.1578](https://doi.org/10.22002/D1.1578)

```{R 9-8, echo=FALSE, screenshot.alt='movie_stills/9_8.jpg' , fig.cap= '(ref:9-8)'}
library(doivideo)
...
(ref:9-9) Bdellovibrio bacteriovorus / Vibrio cholerae Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1579](https://doi.org/10.22002/D1.1579)

```{R 9-9, echo=FALSE, screenshot.alt='movie_stills/9_9.jpg' , fig.cap= '(ref:9-9)'}
library(doivideo)
...
(ref:9-10) Bdellovibrio bacteriovorus / Escherichia coli Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1580](https://doi.org/10.22002/D1.1580)

```{R 9-10, echo=FALSE, screenshot.alt='movie_stills/9_10.jpg' , fig.cap= '(ref:9-10)'}
library(doivideo)
doivideo('10.22002/D1.1580',0)
```

### Bdellovibrio bacteriovorus entry{#Bdellovibrio_bacteriovorus_entry}
...
(ref:9-10a) Bdellovibrio bacteriovorus / Escherichia coli Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1585](https://doi.org/10.22002/D1.1585)

```{R 9-10a, echo=FALSE, screenshot.alt='movie_stills/9_10a.jpg' , fig.cap= '(ref:9-10a)'}
library(doivideo)
...
(ref:9-11) Bdellovibrio bacteriovorus / Vibrio cholerae Collected by: [Yi-Wei Chang](#yi-wei_chang) Movie DOI: [10.22002/D1.1581](https://doi.org/10.22002/D1.1581)

```{R 9-11, echo=FALSE, screenshot.alt='movie_stills/9_11.jpg' , fig.cap= '(ref:9-11)'}
library(doivideo)
