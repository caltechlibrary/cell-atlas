...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/7_1_Soneidensis.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/7_2_Styphimurium.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/7_3_Mhungatei.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/7_4_Vcholerae.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/7_4a_Abrasilense.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/7_5_Mformicica.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/7_5a_Vcholerae.mp4')
} else {
library(doivideo)
...
if(offline==TRUE){
library(embedvideo)
embedvideo('videos/7_6_Mmagneticum.mp4')
} else {
library(doivideo)
