...
```{R 7-1, echo=FALSE, screenshot.alt='movie_stills/7_1.png' , fig.cap= 'Shewanella oneidensis Collected by: Mohammed Kaplan [10.22002/D1.1545](https://doi.org/10.22002/D1.1545)'}
library(doivideo)
...
```{R 7-2, echo=FALSE, screenshot.alt='movie_stills/7_2.png' , fig.cap= 'Salmonella typhimurium Collected by: Morgan Beeby [10.22002/D1.1546](https://doi.org/10.22002/D1.1546)'}
library(doivideo)
...
```{R 7-3, echo=FALSE, screenshot.alt='movie_stills/7_3.png' , fig.cap= 'Methanospirillum hungatei Collected by: Ariane Briegel [10.22002/D1.1547](https://doi.org/10.22002/D1.1547)'}
library(doivideo)
...
```{R 7-4, echo=FALSE, screenshot.alt='movie_stills/7_4.png' , fig.cap= 'Vibrio cholerae Collected by: Ariane Briegel [10.22002/D1.1548](https://doi.org/10.22002/D1.1548)'}
library(doivideo)
...
```{R 7-4a, echo=FALSE, screenshot.alt='movie_stills/7_4a.png' , fig.cap= 'Azospirillum brasilense Collected by: Ariane Briegel [10.22002/D1.1551](https://doi.org/10.22002/D1.1551)'}
library(doivideo)
...
```{R 7-5, echo=FALSE, screenshot.alt='movie_stills/7_5.png' , fig.cap= 'Methanoregula formicica Collected by: Ariane Briegel [10.22002/D1.1549](https://doi.org/10.22002/D1.1549)'}
library(doivideo)
...
```{R 7-5a, echo=FALSE, screenshot.alt='movie_stills/7_5a.png' , fig.cap= 'Vibrio cholerae Collected by: Ariane Briegel [10.22002/D1.1552](https://doi.org/10.22002/D1.1552)'}
library(doivideo)
...
```{R 7-6, echo=FALSE, screenshot.alt='movie_stills/7_6.png' , fig.cap= 'Magnetospirillum magneticum Collected by: Zhuo Li [10.22002/D1.1550](https://doi.org/10.22002/D1.1550)'}
library(doivideo)
